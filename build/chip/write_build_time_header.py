...
def main():
    ...
    parser.add_argument("--gen-dir", help="Path to root of generated file directory tree.")
    parser.add_argument(
        "--use-current-time",
        default=False,
        action="store_true",
    ...
    opts = Options(output=output, define_name=define_name, define_val=str(build_time))
    write_header(opts)
