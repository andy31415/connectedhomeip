...
CHIP_ERROR AppTask::AppInit()
{
    ...
    if (Server::GetInstance().GetTestEventTriggerDelegate() != nullptr)
    {
        TEMPORARY_RETURN_IGNORED Server::GetInstance()
            .GetTestEventTriggerDelegate() -> AddHandler(&sEnergyReportingTestEventTriggerHandler);
        TEMPORARY_RETURN_IGNORED Server::GetInstance()
            .GetTestEventTriggerDelegate() -> AddHandler(&sDeviceEnergyManagementTestEventTriggerHandler);
    }
#endif
