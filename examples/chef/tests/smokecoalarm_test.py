...
class TC_SMOKECOALARM(MatterBaseTest):
    ...
    def steps_TC_SMOKECOALARM(self):
        return [
            TestStep(1, "[TC_SMOKECOALARM] Commissioning already done.", is_commissioning=True),
    ...
    async def _read_co_measured_value(self, endpoint):
        return await self.read_single_attribute_check_success(
            endpoint=endpoint,
            cluster=Clusters.Objects.CarbonMonoxideConcentrationMeasurement,
            attribute=Clusters.Objects.CarbonMonoxideConcentrationMeasurement.Attributes.MeasuredValue,
        )
    ...
    async def _read_humidity_measured_value(self, endpoint):
        return await self.read_single_attribute_check_success(
            endpoint=endpoint,
            cluster=Clusters.Objects.RelativeHumidityMeasurement,
            attribute=Clusters.Objects.RelativeHumidityMeasurement.Attributes.MeasuredValue,
        )
    ...
    async def _read_smoke_co_expressed_state(self, endpoint):
        return await self.read_single_attribute_check_success(
            ...
            attribute=Clusters.Objects.SmokeCoAlarm.Attributes.ExpressedState,
        )
    ...
    async def _read_smoke_co_battery_alert(self, endpoint):
        return await self.read_single_attribute_check_success(
            endpoint=endpoint,
            cluster=Clusters.Objects.SmokeCoAlarm,
            attribute=Clusters.Objects.SmokeCoAlarm.Attributes.BatteryAlert,
        )
    ...
    async def _read_smoke_co_test_in_progress(self, endpoint):
        return await self.read_single_attribute_check_success(
            endpoint=endpoint,
            cluster=Clusters.Objects.SmokeCoAlarm,
            attribute=Clusters.Objects.SmokeCoAlarm.Attributes.TestInProgress,
        )
    ...
    async def _read_smoke_co_hardware_fault_alert(self, endpoint):
        return await self.read_single_attribute_check_success(
            endpoint=endpoint,
            cluster=Clusters.Objects.SmokeCoAlarm,
            attribute=Clusters.Objects.SmokeCoAlarm.Attributes.HardwareFaultAlert,
        )
    ...
    async def _read_smoke_co_end_of_service_alert(self, endpoint):
        return await self.read_single_attribute_check_success(
            endpoint=endpoint,
            cluster=Clusters.Objects.SmokeCoAlarm,
            attribute=Clusters.Objects.SmokeCoAlarm.Attributes.EndOfServiceAlert,
        )
    ...
    async def _read_temperature_measured_value(self, endpoint):
        return await self.read_single_attribute_check_success(
            endpoint=endpoint,
            cluster=Clusters.Objects.TemperatureMeasurement,
            attribute=Clusters.Objects.TemperatureMeasurement.Attributes.MeasuredValue,
        )
