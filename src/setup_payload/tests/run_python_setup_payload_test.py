...
def generate_payloads(in_params):
    payloads = SetupPayload(
        in_params["Long discriminator"],
        in_params["Passcode"],
        in_params["Discovery Bitmask"],
        CommissioningFlow(in_params["Custom flow"]),
        in_params["VendorID"],
        in_params["ProductID"],
    )
...
def test_onboardingcode_parsing():
    ...
    test_data_set = [
        {
            "code": "34970112332",
            "res": get_payload_params(
                discriminator=None, passcode=20202021, discovery=None, flow=0, vid=None, pid=None, version=0, short_discriminator=15
            ),
        },
        {
            "code": "745492075300001000013",
            "res": get_payload_params(
                discriminator=None, passcode=12349876, discovery=None, flow=2, vid=1, pid=1, version=0, short_discriminator=14
            ),
        },
        {
            ...
            "res": get_payload_params(
                ...
                pid=32920,
                version=0,
                short_discriminator=9,
            ),
        },
        {
            "code": "702871264504387000187",
            "res": get_payload_params(
                discriminator=None, passcode=43338551, discovery=None, flow=2, vid=4387, pid=18, version=0, short_discriminator=12
            ),
        },
        {
            "code": "402104334209029041311",
            "res": get_payload_params(
                discriminator=None, passcode=54757432, discovery=None, flow=2, vid=9029, pid=4131, version=0, short_discriminator=0
            ),
        },
        {
            "code": "403732495800069000166",
            "res": get_payload_params(
                discriminator=None, passcode=81235604, discovery=None, flow=2, vid=69, pid=16, version=0, short_discriminator=0
            ),
        },
        {
            "code": "MT:U9VJ0OMV172PX813210",
            "res": get_payload_params(
                discriminator=3431, passcode=49910688, discovery=2, flow=0, vid=4891, pid=2, version=0, short_discriminator=None
            ),
        },
        {
            "code": "MT:00000CQM00KA0648G00",
            "res": get_payload_params(
                discriminator=3840, passcode=20202021, discovery=4, flow=0, vid=0, pid=0, version=0, short_discriminator=None
            ),
        },
        {
            "code": "MT:A3L90ARR15G6N57Y900",
            "res": get_payload_params(
                discriminator=3781, passcode=12349876, discovery=4, flow=1, vid=1, pid=1, version=0, short_discriminator=None
            ),
        },
        {
        ...
        },
        {
            ...
            "res": get_payload_params(
                discriminator=3091, passcode=43338551, discovery=2, flow=2, vid=4387, pid=18, version=0, short_discriminator=12
            ),
        },
        {
            "code": "MT:0A.T0P--00Y0OJ0.510",
            "res": get_payload_params(
                discriminator=80, passcode=54757432, discovery=6, flow=2, vid=9029, pid=4131, version=0, short_discriminator=None
            ),
        },
        {
            "code": "MT:EPX0482F26DAVY09R10",
            "res": get_payload_params(
                discriminator=174, passcode=81235604, discovery=7, flow=1, vid=69, pid=16, version=0, short_discriminator=None
            ),
        },
    ]
