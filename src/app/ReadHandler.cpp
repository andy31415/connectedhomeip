...
ReadHandler::ReadHandler(ManagementCallback & apCallback, Messaging::ExchangeContext * apExchangeContext,
    ...
    mTestAttributePathExpandIterator(InteractionModelEngine::GetInstance()->GetDataModelProvider(), nullptr),
...
ReadHandler::ReadHandler(ManagementCallback & apCallback, Observer * observer) :
    mTestAttributePathExpandIterator(InteractionModelEngine::GetInstance()->GetDataModelProvider(), nullptr), mExchangeCtx(*this),
...
CHIP_ERROR ReadHandler::ProcessAttributePaths(AttributePathIBs::Parser & aAttributePathListParser)
{
    ...
    if (CHIP_END_OF_TLV == err)
    {
        ...
        // TODO: remove
        mTestAttributePathExpandIterator.ResetTo(mpAttributePathList);
...
void ReadHandler::AttributePathIsDirty(const AttributePathParams & aAttributeChanged)
{
...

    {
        ...
        bool hasA = mTestAttributePathExpandIterator.Get(pathA);
    ...
    if (mAttributePathExpandState.GetLastOutputPath(path) &&
        ...
        (aAttributeChanged.HasWildcardClusterId() || aAttributeChanged.mClusterId == path.mClusterId))
    {
        ...
        // TODO: remove
        mTestAttributePathExpandIterator.ResetCurrentCluster();
