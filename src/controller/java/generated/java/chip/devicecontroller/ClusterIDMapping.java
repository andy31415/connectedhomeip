...
public class ClusterIDMapping {
    ...
    public static BaseCluster getCluster(long clusterId) {
        ...
        if (clusterId == CustomOnOffOne.ID) {
            return new CustomOnOffOne();
        }
        if (clusterId == CustomOnOffTwo.ID) {
            return new CustomOnOffTwo();
        }
    ...
    public static class CustomOnOffOne implements BaseCluster {
        public static final long ID = 319422465L;
        public long getID() {
            return ID;
        }
    ...
    public static class CustomOnOffTwo implements BaseCluster {
        public static final long ID = 319422466L;
        public long getID() {
            return ID;
        }
