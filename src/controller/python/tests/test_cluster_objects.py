...
def _encode_from_native_and_then_decode(
    data, cls: typing.Union[ClusterObjects.ClusterObject, ClusterObjects.ClusterAttributeDescriptor]
):
    tlv = TLVWriter()
    tlv.put(None, data)
...
class TestClusterObjects(unittest.TestCase):
    ...
    class C(ClusterObjects.ClusterObject):
        ...
        def descriptor(cls) -> ClusterObjects.ClusterObjectDescriptor:
            return ClusterObjects.ClusterObjectDescriptor(
                Fields=[
                    ClusterObjects.ClusterObjectFieldDescriptor(Label="X", Tag=0, Type=uint),
                    ClusterObjects.ClusterObjectFieldDescriptor(Label="Y", Tag=1, Type=int),
                ]
            )
    ...
    def test_basic_decode(self):
        res = _encode_from_native_and_then_decode({0: uint(5), 1: 23}, TestClusterObjects.C)
    ...
    class StructWithArray(ClusterObjects.ClusterObject):
        ...
        def descriptor(cls) -> ClusterObjects.ClusterObjectDescriptor:
            return ClusterObjects.ClusterObjectDescriptor(
                Fields=[
                    ClusterObjects.ClusterObjectFieldDescriptor(Label="X", Tag=0, Type=typing.List[uint]),
                    ClusterObjects.ClusterObjectFieldDescriptor(Label="Y", Tag=1, Type=int),
                ]
            )
    ...
    def test_struct_w_array_decode(self):
        res = _encode_from_native_and_then_decode({0: [uint(5), uint(6)], 1: 23}, TestClusterObjects.StructWithArray)
        self.assertEqual(res, TestClusterObjects.StructWithArray(X=[5, 6], Y=23))
    ...
    class StructWithEmbeddedStructAndString(ClusterObjects.ClusterObject):
        ...
        def descriptor(cls) -> ClusterObjects.ClusterObjectDescriptor:
            return ClusterObjects.ClusterObjectDescriptor(
                Fields=[
                    ClusterObjects.ClusterObjectFieldDescriptor(Label="X", Tag=0, Type=str),
                    ClusterObjects.ClusterObjectFieldDescriptor(Label="Y", Tag=1, Type=TestClusterObjects.C),
                    ClusterObjects.ClusterObjectFieldDescriptor(Label="Z", Tag=2, Type=bytes),
                ]
            )
    ...
    def test_struct_w_string_and_string_encode(self):
        ...
        res = _encode_and_then_decode_to_native(data)
        self.assertEqual(res, {0: "test-str", 1: {0: 12, 1: 34}, 2: b"byte-string"})

    def test_struct_w_string_and_string_decode(self):
        res = _encode_from_native_and_then_decode(
            {0: "test-str", 1: {0: uint(12), 1: 34}, 2: b"byte-string"}, TestClusterObjects.StructWithEmbeddedStructAndString
        )
        self.assertEqual(
            res,
    ...
    class StructWithArrayOfStructWithArray(ClusterObjects.ClusterObject):
        ...
        def descriptor(cls) -> ClusterObjects.ClusterObjectDescriptor:
            return ClusterObjects.ClusterObjectDescriptor(
                Fields=[
                    ClusterObjects.ClusterObjectFieldDescriptor(Label="X", Tag=0, Type=typing.List[str]),
                    ClusterObjects.ClusterObjectFieldDescriptor(Label="Y", Tag=1, Type=typing.List[TestClusterObjects.C]),
    ...
    def test_struct_with_array_of_struct_with_array_encode(self):
        ...
        data = TestClusterObjects.StructWithArrayOfStructWithArray(
            ...
            Z=[SWA(X=[12, 34], Y=5678), SWA(X=[1, 3], Y=57), SWA(X=[2, 4], Y=68), SWA(X=[233, 333], Y=333)],
        ...
        self.assertEqual(
            res,
            {
                ...
                2: [{0: [12, 34], 1: 5678}, {0: [1, 3], 1: 57}, {0: [2, 4], 1: 68}, {0: [233, 333], 1: 333}],
...
class TestAttributeDescriptor(unittest.TestCase):
    ...
    def test_basic_encode(self):
        res = _encode_attribute_and_then_decode_to_native(42, TestAttributeDescriptor.IntAttribute)
        self.assertEqual(res, 42)

    def test_basic_decode(self):
        res = _encode_from_native_and_then_decode(42, TestAttributeDescriptor.IntAttribute)
        self.assertEqual(res, 42)
    ...
    def test_struct_encode(self):
        res = _encode_attribute_and_then_decode_to_native(TestClusterObjects.C(X=42, Y=24), TestAttributeDescriptor.StructAttribute)
        self.assertEqual(res, {0: 42, 1: 24})

    def test_struct_decode(self):
        res = _encode_from_native_and_then_decode({0: uint(42), 1: 24}, TestClusterObjects.C)
    ...
    def test_array_encode(self):
        res = _encode_attribute_and_then_decode_to_native([1, 2, 3, 4, 5], TestAttributeDescriptor.ArrayAttribute)
        self.assertEqual(res, [1, 2, 3, 4, 5])

    def test_array_decode(self):
        res = _encode_from_native_and_then_decode([1, 2, 3, 4, 5], TestAttributeDescriptor.ArrayAttribute)
        self.assertEqual(res, [1, 2, 3, 4, 5])
