...
class restartRemoteDevice(threading.Thread):
    def __init__(self, remote_ip: str, ssh_port: int, user: str, password: str, remote_server_app: str, extra_args: str):
    ...
    def run(self):
        ...
        try:
            ...
            ).format(os.path.join(CHIP_REPO, "out/debug", self.remote_server_app), self.extra_args)
