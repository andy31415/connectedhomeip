...
__all__ = [
    ...
    "AttributeReadRequestList",
    "SubscriptionTargetList",
]
...
AttributeReadRequest = typing.Union[
    ...
    typing.Tuple[int, typing.Type[ClusterObjects.Cluster]],  # Wildcard attribute id
    # Concrete path
...
SubscriptionTargetList = typing.List[
    typing.Tuple[int, typing.Union[ClusterObjects.Cluster, ClusterObjects.ClusterAttributeDescriptor]]
]
...
_DevicePairingDelegate_OnCommissioningCompleteFunct = CFUNCTYPE(None, c_uint64, PyChipError)
_DevicePairingDelegate_OnOpenWindowCompleteFunct = CFUNCTYPE(None, c_uint64, c_uint32, c_char_p, c_char_p, PyChipError)
...
_DevicePairingDelegate_OnCommissioningStatusUpdateFunct = CFUNCTYPE(None, c_uint64, c_uint64, c_uint8, PyChipError)

DevicePairingDelegate_OnCommissioningStageStartFunct: typing.TypeAlias = typing.Callable[
    [int, bytes],
    None,
]
_DevicePairingDelegate_OnCommissioningStageStartFunct = CFUNCTYPE(None, c_uint64, c_char_p)

_DevicePairingDelegate_OnFabricCheckFunct = CFUNCTYPE(None, c_uint64)
...
class ICDRegistrationParameters:
    ...
    class CStruct(Structure):
        _fields_ = [
            ("symmetricKey", c_char_p),
            ("symmetricKeyLength", c_size_t),
            ("checkInNodeId", c_uint64),
            ("monitoredSubject", c_uint64),
            ("stayActiveMsec", c_uint32),
            ("clientType", c_uint8),
        ]

    def to_c(self):
        return ICDRegistrationParameters.CStruct(
            self.symmetricKey,
            len(self.symmetricKey),
            self.checkInNodeId,
            self.monitoredSubject,
            self.stayActiveMs,
...
class DeviceProxyWrapper:
    ...
    def __del__(self):
        ...
        if (
            self._proxyType == self.DeviceProxyType.OPERATIONAL
            and self._dmLib is not None
            and hasattr(builtins, "chipStack")
            and builtins.chipStack is not None
        ):
    ...
    def closeTCPConnectionWithPeer(self):
        ...
        builtins.chipStack.Call(lambda: self._dmLib.pychip_CloseTCPConnectionWithPeer(self._deviceProxy)).raise_on_error()
...
class ChipDeviceControllerBase:
    ...
    def _set_dev_ctrl(self, devCtrl, pairingDelegate):
        ...
        def HandleOpenWindowComplete(
            nodeId: int, setupPinCode: int, setupManualCode: bytes, setupQRCode: bytes, err: PyChipError
        ) -> None:
            if err.is_success:
        ...
        self.cbHandlePASEEstablishmentCompleteFunct = _DevicePairingDelegate_OnPairingCompleteFunct(HandlePASEEstablishmentComplete)
        ...
        self.cbHandleCommissioningCompleteFunct = _DevicePairingDelegate_OnCommissioningCompleteFunct(HandleCommissioningComplete)
        ...
        self.cbHandleOpenWindowCompleteFunct = _DevicePairingDelegate_OnOpenWindowCompleteFunct(HandleOpenWindowComplete)
    ...
    def Shutdown(self):
        ...
        if self.devCtrl is not None:
            self._ChipStack.Call(
                lambda: self._dmLib.pychip_DeviceController_DeleteDeviceController(self.devCtrl, self.pairingDelegate)
            ).raise_on_error()
    ...
    def IsConnected(self):
        ...
        return self._ChipStack.Call(lambda: self._dmLib.pychip_DeviceController_IsConnected(self.devCtrl))
    ...
    async def ConnectNFC(self, discriminator: int, setupPinCode: int, nodeId: int) -> int:
        ...
        async with self._commissioning_context as ctx:
            self._enablePairingCompleteCallback(True)
            await self._ChipStack.CallAsync(
                lambda: self._dmLib.pychip_DeviceController_ConnectNFC(self.devCtrl, discriminator, setupPinCode, nodeId)
            )
    ...
    async def ContinueCommissioningAfterConnectNetworkRequest(self, nodeId: int) -> int:
        ...
        async with self._commissioning_context as ctx:
            ...
            await self._ChipStack.CallAsync(
                lambda: self._dmLib.pychip_DeviceController_ContinueCommissioningAfterConnectNetworkRequest(self.devCtrl, nodeId)
            )
            return await asyncio.futures.wrap_future(ctx.future)
    ...
    def CloseBLEConnection(self):
        ...
        self._ChipStack.Call(lambda: self._dmLib.pychip_DeviceCommissioner_CloseBleConnection(self.devCtrl)).raise_on_error()
    ...
    def MarkSessionDefunct(self, nodeId: int):
        ...
        self._ChipStack.Call(lambda: self._dmLib.pychip_DeviceController_MarkSessionDefunct(self.devCtrl, nodeId)).raise_on_error()
    ...
    def MarkSessionForEviction(self, nodeId: int):
        ...
        self._ChipStack.Call(
            lambda: self._dmLib.pychip_DeviceController_MarkSessionForEviction(self.devCtrl, nodeId)
        ).raise_on_error()
    ...
    def DeleteAllSessionResumptionStorage(self):
        ...
        self.CheckIsActive()
        self._ChipStack.Call(lambda: self._dmLib.pychip_DeviceController_DeleteAllSessionResumption(self.devCtrl)).raise_on_error()
    ...
    def ResetLocalMRPConfig(self):
        ...
        """
        self.CheckIsActive()
        self._ChipStack.Call(lambda: self._dmLib.pychip_DeviceController_ResetLocalMRPConfig()).raise_on_error()
    ...
    async def EstablishPASESessionBLE(self, setupPinCode: int, discriminator: int, nodeId: int) -> None:
        ...
        await self._establishPASESession(
            lambda: self._dmLib.pychip_DeviceController_EstablishPASESessionBLE(self.devCtrl, setupPinCode, discriminator, nodeId)
        )
    ...
    async def EstablishPASESession(self, setUpCode: str, nodeId: int) -> None:
        ...
        """
        await self._establishPASESession(
            lambda: self._dmLib.pychip_DeviceController_EstablishPASESession(self.devCtrl, setUpCode.encode("utf-8"), nodeId)
        )
    ...
    def SetTestCommissionerPrematureCompleteAfter(self, stage: int):
        ...
        """
        return self._dmLib.pychip_SetTestCommissionerPrematureCompleteAfter(stage)
    ...
    def CheckTestCommissionerCallbacks(self):
        ...
        """
        return self._ChipStack.Call(lambda: self._dmLib.pychip_TestCommissioningCallbacks())
    ...
    def CheckStageSuccessful(self, stage: int):
        ...
        """
        return self._ChipStack.Call(lambda: self._dmLib.pychip_TestCommissioningStageSuccessful(stage))
    ...
    async def OpenCommissioningWindow(
        self, nodeId: int, timeout: int, iteration: int, discriminator: int, option: CommissioningWindowPasscode
    ) -> CommissioningParameters:
        """
    ...
    async def OpenJointCommissioningWindow(
        self, nodeId: int, endpointId: int, timeout: int, iteration: int, discriminator: int
    ) -> CommissioningParameters:
        """
    ...
    def GetCompressedFabricId(self):
        ...
        self._ChipStack.Call(
            lambda: self._dmLib.pychip_DeviceController_GetCompressedFabricId(self.devCtrl, pointer(fabricid))
        ).raise_on_error()
    ...
    def GetFabricIdInternal(self) -> int:
        ...
        self._ChipStack.Call(
            lambda: self._dmLib.pychip_DeviceController_GetFabricId(self.devCtrl, pointer(fabricid))
        ).raise_on_error()
    ...
    def GetFabricIndexInternal(self) -> int:
        ...
        self._ChipStack.Call(
            lambda: self._dmLib.pychip_DeviceController_GetFabricIndex(self.devCtrl, pointer(fabricindex))
        ).raise_on_error()
    ...
    def GetNodeIdInternal(self) -> int:
        ...
        self._ChipStack.Call(lambda: self._dmLib.pychip_DeviceController_GetNodeId(self.devCtrl, pointer(nodeId))).raise_on_error()
    ...
    async def FindOrEstablishPASESession(
        self, setupCode: str, nodeId: int, timeoutMs: typing.Optional[int] = None
        ...
        res = await self._ChipStack.CallAsyncWithResult(
            lambda: self._dmLib.pychip_GetDeviceBeingCommissioned(self.devCtrl, nodeId, byref(returnDevice)), timeoutMs
        )
        if res.is_success:
    ...
    async def WaitForActive(self, nodeId: int, *, timeoutSeconds=30.0, stayActiveDurationMs=30000):
        ...
        return await self.SendCommand(
            nodeId, 0, Clusters.IcdManagement.Commands.StayActiveRequest(stayActiveDuration=stayActiveDurationMs)
        )
    ...
    def ComputeRoundTripTimeout(self, nodeId: int, upperLayerProcessingTimeoutMs: int = 0):
        ...
        return self._ChipStack.Call(
            lambda: self._dmLib.pychip_DeviceProxy_ComputeRoundTripTimeout(device.deviceProxy, upperLayerProcessingTimeoutMs)
        )
    ...
    def GetRemoteSessionParameters(self, nodeId: int) -> typing.Optional[SessionParameters]:
        ...
        device = self.GetConnectedDeviceSync(nodeId)
        self._ChipStack.Call(
            lambda: self._dmLib.pychip_DeviceProxy_GetRemoteSessionParameters(
        ...
        return SessionParameters(
            sessionIdleInterval=sessionParametersStruct.SessionIdleInterval
            if sessionParametersStruct.SessionIdleInterval != 0
            else None,
            sessionActiveInterval=sessionParametersStruct.SessionActiveInterval
            if sessionParametersStruct.SessionActiveInterval != 0
            else None,
            sessionActiveThreshold=sessionParametersStruct.SessionActiveThreshold
            if sessionParametersStruct.SessionActiveThreshold != 0
            else None,
            dataModelRevision=sessionParametersStruct.DataModelRevision if sessionParametersStruct.DataModelRevision != 0 else None,
            interactionModelRevision=sessionParametersStruct.InteractionModelRevision
            if sessionParametersStruct.InteractionModelRevision != 0
            else None,
            specificationVersion=sessionParametersStruct.SpecificationVersion
            if sessionParametersStruct.SpecificationVersion != 0
            else None,
    ...
    async def TestOnlySendBatchCommands(
        ...
        ClusterCommand.TestOnlySendBatchCommands(
            ...
            remoteMaxPathsPerInvoke=remoteMaxPathsPerInvoke,
            suppressTimedRequestMessage=suppressTimedRequestMessage,
            commandRefsOverride=commandRefsOverride,
        ).raise_on_error()
        return await future

    async def TestOnlySendCommandTimedRequestFlagWithNoTimedInvoke(
        self, nodeId: int, endpoint: int, payload: ClusterObjects.ClusterCommand, responseType=None
    ):
        """
            ...
            if len(v) == 2:
                attrs.append(
                    ClusterAttribute.AttributeWriteRequest(
                        EndpointId=v[0], Attribute=v[1], DataVersion=0, HasDataVersion=0, Data=v[1].value
                    )
                )  # type: ignore[attr-defined]
            else:
                attrs.append(
                    ClusterAttribute.AttributeWriteRequest(
                        EndpointId=v[0], Attribute=v[1], DataVersion=v[2], HasDataVersion=1, Data=v[1].value
                    )
                )
        return attrs
    ...
    async def SendCommand(
        ...
        allow_large_payload = (
            ...
            or payloadCapability == TransportPayloadCapability.MRP_OR_TCP_PAYLOAD
        )
        res = await ClusterCommand.SendCommand(
            ...
            busyWaitMs=busyWaitMs,
            suppressResponse=suppressResponse,
            allowLargePayload=allow_large_payload,
        )
        res.raise_on_error()
        return await future
    ...
    def SendGroupCommand(self, groupid: int, payload: ClusterObjects.ClusterCommand, busyWaitMs: typing.Optional[int] = None):
        ...
        ClusterCommand.SendGroupCommand(groupid, self.devCtrl, payload, busyWaitMs=busyWaitMs).raise_on_error()
    ...
    async def WriteAttribute(
        ...
        return await self._WriteAttribute(
            nodeId=nodeId,
    ...
    async def _WriteAttribute(
        ...
        busyWaitMs: typing.Optional[int] = None,
        payloadCapability: int = TransportPayloadCapability.MRP_PAYLOAD,
        forceLegacyListEncoding: bool = False,
    ):
        self.CheckIsActive()
        ...
        ClusterAttribute.WriteAttributes(
            ...
            interactionTimeoutMs=interactionTimeoutMs,
            busyWaitMs=busyWaitMs,
            forceLegacyListEncoding=forceLegacyListEncoding,
        ).raise_on_error()
        return await future
    ...
    def WriteGroupAttribute(
        self,
        groupid: int,
        attributes: typing.List[typing.Tuple[ClusterObjects.ClusterAttributeDescriptor, int]],
        busyWaitMs: typing.Optional[int] = None,
    ):
        """
        ...
        for v in attributes:
            if len(v) == 2:
                ...
                attrs.append(ClusterAttribute.AttributeWriteRequest(invalid_endpoint, v[0], 0, 0, v[0].value))

        assert self.devCtrl is not None
        ClusterAttribute.WriteGroupAttributes(groupid, self.devCtrl, attrs, busyWaitMs=busyWaitMs).raise_on_error()
    ...
    def _parseDataVersionFilterTuple(self, pathTuple: typing.List[typing.Tuple[int, typing.Type[ClusterObjects.Cluster], int]]):
        ...
        return ClusterAttribute.DataVersionFilter.from_cluster(EndpointId=endpoint, Cluster=cluster, DataVersion=dataVersion)  # type: ignore[arg-type]
    ...
    def _parseEventPathTuple(
        ...
        if issubclass(pathTuple[1], ClusterObjects.Cluster):  # type: ignore[arg-type]
            return ClusterAttribute.EventPath.from_cluster(
                EndpointId=pathTuple[0],  # type: ignore[arg-type]
                Cluster=pathTuple[1],
                Urgent=urgent,  # type: ignore[arg-type]
            )
    ...
    async def Read(
        ...
        attributePaths = [self._parseAttributePathTuple(v) for v in attributes] if attributes else None
        clusterDataVersionFilters = (
            [self._parseDataVersionFilterTuple(v) for v in dataVersionFilters] if dataVersionFilters else None
        )  # type: ignore[arg-type]
        eventPaths = [self._parseEventPathTuple(v) for v in events] if events else None

        allowLargePayload = payloadCapability in (
            TransportPayloadCapability.LARGE_PAYLOAD,
        ...
        ClusterAttribute.Read(
            ...
            subscriptionParameters=ClusterAttribute.SubscriptionParameters(reportInterval[0], reportInterval[1])
            if reportInterval
            else None,
            fabricFiltered=fabricFiltered,
            keepSubscriptions=keepSubscriptions,
            autoResubscribe=autoResubscribe,
            allowLargePayload=allowLargePayload,
        ).raise_on_error()
        await future
    ...
    def SetIpk(self, ipk: bytes):
        ...
        Raises:
            ChipStackError: On failure.
        """
        self._ChipStack.Call(lambda: self._dmLib.pychip_DeviceController_SetIpk(self.devCtrl, ipk, len(ipk))).raise_on_error()
    ...
    def InitGroupTestingData(self):
        ...
        self._ChipStack.Call(lambda: self._dmLib.pychip_OpCreds_InitGroupTestingData(self.devCtrl)).raise_on_error()
    ...
    def SetGroupKeySet(
        ...
        epoch_key1: typing.Optional[bytes] = None,
        epoch_start_time1: int = 0,
        epoch_key2: typing.Optional[bytes] = None,
    ...
    def SetGroupInfo(self, group_id: int, group_name: str, flags: int = 0x02):
        ...
        self._ChipStack.Call(
            lambda: self._dmLib.pychip_OpCreds_SetGroupInfo(self.devCtrl, group_id, group_name.encode("utf-8"), flags)
        ).raise_on_error()
    ...
    def AddGroupEndpoint(self, group_id: int, endpoint_id: int):
        ...
        self._ChipStack.Call(
            lambda: self._dmLib.pychip_OpCreds_AddGroupEndpoint(self.devCtrl, group_id, endpoint_id)
        ).raise_on_error()
    ...
    def SetGroupKey(self, group_id: int, keyset_id: int):
        ...
        self._ChipStack.Call(lambda: self._dmLib.pychip_OpCreds_SetGroupKey(self.devCtrl, group_id, keyset_id)).raise_on_error()
    ...
    def _InitLib(self):
        if self._dmLib is None:
            ...
            self._dmLib.pychip_DeviceController_ConnectBLE.argtypes = [c_void_p, c_uint16, c_bool, c_uint32, c_uint64]
            self._dmLib.pychip_DeviceController_ConnectBLE.restype = PyChipError

            self._dmLib.pychip_DeviceController_ConnectNFC.argtypes = [c_void_p, c_uint16, c_uint32, c_uint64]
            self._dmLib.pychip_DeviceController_ConnectNFC.restype = PyChipError

            self._dmLib.pychip_DeviceController_ContinueCommissioningAfterConnectNetworkRequest.argtypes = [c_void_p, c_uint64]
            self._dmLib.pychip_DeviceController_ContinueCommissioningAfterConnectNetworkRequest.restype = PyChipError

            self._dmLib.pychip_DeviceController_SetThreadOperationalDataset.argtypes = [c_char_p, c_uint32]
            ...
            self._dmLib.pychip_DeviceController_SetTimeZone.argtypes = [c_int32, c_uint64, c_char_p]

            # Currently only supports 1 list item
            self._dmLib.pychip_DeviceController_SetDSTOffset.restype = PyChipError
            self._dmLib.pychip_DeviceController_SetDSTOffset.argtypes = [c_int32, c_uint64, c_uint64]
            ...
            self._dmLib.pychip_DeviceController_SetIcdRegistrationParameters.argtypes = [c_bool, c_void_p]
            ...
            self._dmLib.pychip_DeviceController_DiscoverCommissionableNodes.argtypes = [c_void_p, c_uint8, c_char_p]
            self._dmLib.pychip_DeviceController_DiscoverCommissionableNodes.restype = PyChipError

            self._dmLib.pychip_DeviceController_StopCommissionableDiscovery.argtypes = [c_void_p]
            self._dmLib.pychip_DeviceController_StopCommissionableDiscovery.restype = PyChipError

            self._dmLib.pychip_DeviceController_EstablishPASESessionIP.argtypes = [c_void_p, c_char_p, c_uint32, c_uint64, c_uint16]
            ...
            self._dmLib.pychip_DeviceController_EstablishPASESessionBLE.argtypes = [c_void_p, c_uint32, c_uint16, c_uint64]
            self._dmLib.pychip_DeviceController_EstablishPASESessionBLE.restype = PyChipError

            self._dmLib.pychip_DeviceController_EstablishPASESession.argtypes = [c_void_p, c_char_p, c_uint64]
            ...
            self._dmLib.pychip_DeviceController_ConnectWithCode.argtypes = [c_void_p, c_char_p, c_uint64, c_uint8]
            self._dmLib.pychip_DeviceController_ConnectWithCode.restype = PyChipError

            self._dmLib.pychip_DeviceController_UnpairDevice.argtypes = [c_void_p, c_uint64, _DeviceUnpairingCompleteFunct]
            self._dmLib.pychip_DeviceController_UnpairDevice.restype = PyChipError

            self._dmLib.pychip_DeviceController_MarkSessionDefunct.argtypes = [c_void_p, c_uint64]
            self._dmLib.pychip_DeviceController_MarkSessionDefunct.restype = PyChipError

            self._dmLib.pychip_DeviceController_MarkSessionForEviction.argtypes = [c_void_p, c_uint64]
            self._dmLib.pychip_DeviceController_MarkSessionForEviction.restype = PyChipError

            self._dmLib.pychip_DeviceController_DeleteAllSessionResumption.argtypes = [c_void_p]
            ...
            self._dmLib.pychip_ScriptDevicePairingDelegate_SetOpenWindowCompleteCallback.argtypes = [
                c_void_p,
                _DevicePairingDelegate_OnOpenWindowCompleteFunct,
            ]
            ...
            self._dmLib.pychip_ScriptDevicePairingDelegate_SetCommissioningStageStartCallback.argtypes = [
                c_void_p,
                _DevicePairingDelegate_OnCommissioningStageStartFunct,
            ]
            ...
            self._dmLib.pychip_ScriptDevicePairingDelegate_SetExpectingPairingComplete.argtypes = [c_void_p, c_bool]
            ...
            self._dmLib.pychip_FreeOperationalDeviceProxy.argtypes = [c_void_p]
            ...
            self._dmLib.pychip_DeviceController_GetCompressedFabricId.argtypes = [c_void_p, POINTER(c_uint64)]
            ...
            self._dmLib.pychip_SetTestCommissionerSimulateFailureOnStage.argtypes = [c_uint8]
            self._dmLib.pychip_SetTestCommissionerSimulateFailureOnStage.restype = c_bool

            self._dmLib.pychip_SetTestCommissionerSimulateFailureOnReport.argtypes = [c_uint8]
            self._dmLib.pychip_SetTestCommissionerSimulateFailureOnReport.restype = c_bool

            self._dmLib.pychip_SetTestCommissionerPrematureCompleteAfter.argtypes = [c_uint8]
            ...
            self._dmLib.pychip_GetCommissioningRCACData.argtypes = [
            ...
            self._dmLib.pychip_DeviceController_IssueNOCChain.argtypes = [c_void_p, py_object, c_char_p, c_size_t, c_uint64]
            self._dmLib.pychip_DeviceController_IssueNOCChain.restype = PyChipError

            self._dmLib.pychip_OpCreds_InitGroupTestingData.argtypes = [c_void_p]
            ...
            self._dmLib.pychip_OpCreds_AllocateController.argtypes = [
                c_void_p,
                POINTER(c_void_p),
                POINTER(c_void_p),
                c_uint64,
...
class ChipDeviceController(ChipDeviceControllerBase):
    ...
    def __init__(
        ...
        super().__init__(name or f"caIndex({fabricAdmin.caIndex:x})/fabricId(0x{fabricId:016X})/nodeId(0x{nodeId:016X})")
        ...
        self._ChipStack.Call(
            lambda: self._dmLib.pychip_OpCreds_AllocateController(
                ...
                useTestCommissioner,
                self._ChipStack.enableServerInteractions,
                c_catTags,
                len(catTags),
                None if keypair is None else keypair.native_object,
            )
        ).raise_on_error()
    ...
    async def Commission(self, nodeId: int) -> int:
        ...
        async with self._commissioning_context as ctx:
            self._enablePairingCompleteCallback(False)
            await self._ChipStack.CallAsync(lambda: self._dmLib.pychip_DeviceController_Commission(self.devCtrl, nodeId))

            return await asyncio.futures.wrap_future(ctx.future)

    async def CommissionBleThread(
        self, discriminator, setupPinCode, nodeId: int, threadOperationalDataset: bytes, isShortDiscriminator: bool = False
    ) -> int:
        """
    ...
    async def CommissionBleWiFi(
        self, discriminator, setupPinCode, nodeId: int, ssid: str, credentials: str, isShortDiscriminator: bool = False
    ) -> int:
        """
    ...
    def SetWiFiCredentials(self, ssid: str, credentials: str):
        ...
        self._ChipStack.Call(
            lambda: self._dmLib.pychip_DeviceController_SetWiFiCredentials(ssid.encode("utf-8"), credentials.encode("utf-8"))
        ).raise_on_error()
    ...
    def ResetCommissioningParameters(self):
        ...
        """
        self.CheckIsActive()
        self._ChipStack.Call(lambda: self._dmLib.pychip_DeviceController_ResetCommissioningParameters()).raise_on_error()
    ...
    def SetDefaultNTP(self, defaultNTP: str):
        ...
        """
        self.CheckIsActive()
        self._ChipStack.Call(lambda: self._dmLib.pychip_DeviceController_SetDefaultNtp(defaultNTP.encode("utf-8"))).raise_on_error()
    ...
    def SetTrustedTimeSource(self, nodeId: int, endpoint: int):
        ...
        """
        self.CheckIsActive()
        self._ChipStack.Call(lambda: self._dmLib.pychip_DeviceController_SetTrustedTimeSource(nodeId, endpoint)).raise_on_error()
    ...
    def SetCheckMatchingFabric(self, check: bool):
        ...
        """
        self.CheckIsActive()
        self._ChipStack.Call(lambda: self._dmLib.pychip_DeviceController_SetCheckMatchingFabric(check)).raise_on_error()
    ...
    def GenerateICDRegistrationParameters(self):
        ...
        return ICDRegistrationParameters(
            secrets.token_bytes(16), self._nodeId, self._nodeId, 30, Clusters.IcdManagement.Enums.ClientTypeEnum.kPermanent
        )
    ...
    def EnableICDRegistration(self, parameters: ICDRegistrationParameters):
        ...
        self.CheckIsActive()
        self._ChipStack.Call(
            lambda: self._dmLib.pychip_DeviceController_SetIcdRegistrationParameters(True, pointer(parameters.to_c()))
        ).raise_on_error()
    ...
    def DisableICDRegistration(self):
        ...
        """
        self.CheckIsActive()
        self._ChipStack.Call(lambda: self._dmLib.pychip_DeviceController_SetIcdRegistrationParameters(False, None)).raise_on_error()
        ...
        async with self._commissioning_context as ctx:
            ...
            await self._ChipStack.CallAsync(
                lambda: self._dmLib.pychip_DeviceController_OnNetworkCommission(
                    self.devCtrl,
                    self.pairingDelegate,
                    nodeId,
                    setupPinCode,
                    int(filterType),
                    str(filter).encode("utf-8") if filter is not None else None,
    ...
    async def CommissionThreadMeshcop(
        self,
        nodeId: int,
        setupPinCode: int,
        discriminator: int,
        borderAgentIPAddr: str,
        borderAgentPort: int,
        ...
        async with self._commissioning_context as ctx:
            ...
            await self._ChipStack.CallAsync(
                lambda: self._dmLib.pychip_DeviceController_ThreadMeshcopCommission(
                    ...
                    setupPinCode,
                    discriminator,
                    borderAgentIPAddr.encode("utf-8"),
                    borderAgentPort,
                )
            )
    ...
    async def CommissionWithCode(
        self, setupPayload: str, nodeId: int, discoveryType: DiscoveryType = DiscoveryType.DISCOVERY_ALL
    ) -> int:
        """
...
class BareChipDeviceController(ChipDeviceControllerBase):
    ...
    def __init__(
        self,
        operationalKey: p256keypair.P256Keypair,
        noc: bytes,
        ...
        self._ChipStack.Call(
            lambda: self._dmLib.pychip_OpCreds_AllocateControllerForPythonCommissioningFLow(
                cast(devCtrl, c_void_p),
                cast(pairingDelegate, c_void_p),
                nativeKey,
                noc,
                len(noc),
                icac,
                len(icac) if icac else 0,
                rcac,
                len(rcac),
                ipk,
                len(ipk) if ipk else 0,
                adminVendorId,
                self._ChipStack.enableServerInteractions,
            )
        ).raise_on_error()
