...
def GetLibraryHandle() -> ctypes.CDLL:
  """Get a memoized native library handle."""

  global _nativeLibraryHandle
  if _nativeLibraryHandle is None:
    _nativeLibraryHandle = ctypes.CDLL(FindNativeLibraryPath())

    # TODO: this is garbage, move away:
    _nativeLibraryHandle.pychip_ble_init.args = []
    _nativeLibraryHandle.pychip_ble_init.restype = ctypes.c_uint32
    _nativeLibraryHandle.test.args = []
    _nativeLibraryHandle.test.restype = None
