...
oids = [
    ...
    (
        ...
        "MatterNodeId",
        17,
        [iso(1), organization(3), dod(6), internet(1), private(4), enterprise(1), zigbee(37244), matter(1), 1],
    ),
    (
        "AttributeType",
        "MatterFirmwareSigningId",
        18,
        [iso(1), organization(3), dod(6), internet(1), private(4), enterprise(1), zigbee(37244), matter(1), 2],
    ),
    (
        "AttributeType",
        "MatterICACId",
        19,
        [iso(1), organization(3), dod(6), internet(1), private(4), enterprise(1), zigbee(37244), matter(1), 3],
    ),
    (
        "AttributeType",
        "MatterRCACId",
        20,
        [iso(1), organization(3), dod(6), internet(1), private(4), enterprise(1), zigbee(37244), matter(1), 4],
    ),
    (
        "AttributeType",
        "MatterFabricId",
        21,
        [iso(1), organization(3), dod(6), internet(1), private(4), enterprise(1), zigbee(37244), matter(1), 5],
    ),
    (
        "AttributeType",
        "MatterCASEAuthTag",
        22,
        [iso(1), organization(3), dod(6), internet(1), private(4), enterprise(1), zigbee(37244), matter(1), 6],
    ),
    (
        "AttributeType",
        "MatterVidVerificationSignerId",
        23,
        [iso(1), organization(3), dod(6), internet(1), private(4), enterprise(1), zigbee(37244), matter(1), 7],
    ),
    # Elliptic Curves
    ...
    ("Extension", "CSRRequest", 6, [iso(1), member_body(2), us(840), rsadsi(113549), pkcs(1), 9, 14]),
    # Key Purposes
...
for catName, oidName, oidEnum, oid in oids:
    oid_utf8_strings += "static const uint8_t sOID_%s_%s[] = { %s };\n" % (
        catName,
        oidName,
        ", ".join(["0x%02X" % (x) for x in encodeOID(oid)]),
    )
