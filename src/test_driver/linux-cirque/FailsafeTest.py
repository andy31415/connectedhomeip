...
class TestFailsafe(CHIPVirtualHome):
    ...
    def run_controller_test(self):
        ...
        command = (
            "gdb -return-child-result -q -ex run -ex bt --args python3 {} -t 150 -d {} -c {} --paa-trust-store-path {}".format(
                os.path.join(CHIP_REPO, "src/controller/python/tests/scripts/failsafe_tests.py"),
                TEST_DISCRIMINATOR,
                TEST_PASSCODE,
