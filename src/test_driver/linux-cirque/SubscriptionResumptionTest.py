...
class TestSubscriptionResumption(CHIPVirtualHome):
    ...
    def run_subscription_resumption_test(self):
        ...
        self.execute_device_cmd(
            ...
            ).format(os.path.join(CHIP_REPO, "out/debug", TEST_END_DEVICE_APP), TEST_DISCRIMINATOR),
        )
        ...
        command = (
            ...
            os.path.join(CHIP_REPO, "src/controller/python/tests/scripts/subscription_resumption_test.py"),
            ethernet_ip,
        ...
        self.assertTrue(
            self.sequenceMatch(
                ...
                ["Resuming 1 subscriptions in 1 seconds", "Registered a ReadHandler that will schedule a report"],
            ),
