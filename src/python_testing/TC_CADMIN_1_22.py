...
class TC_CADMIN_1_22_24(CADMINBaseTest):
    ...
    def steps_TC_CADMIN_1_22(self) -> list[TestStep]:
        return [
            ...
            TestStep(7, "TH_CR1 opens a commissioning window on DUT_CE using ECM with a value of 180 seconds", "Result is SUCCESS"),
            TestStep(8, "TH_CR1 sends a RevokeCommissioning command to the DUT_CE", "Result is SUCCESS"),
            TestStep(
                9,
    ...
    async def test_TC_CADMIN_1_22(self):
        ...
        asserts.assert_equal(
            cm.exception.err, _INVALID_COMMAND, "Expected to error as we provided failure value for opening commissioning window"
        )
