...
class TC_WebRTCP_2_27(MatterBaseTest, WEBRTCPTestBase):
    ...
    def steps_TC_WebRTCP_2_27(self) -> list[TestStep]:
        """
        ...
        return [
            ...
            TestStep("2a", "Send SolicitOffer with both VideoStreamID and VideoStreams set => expect INVALID_COMMAND"),
            TestStep(3, "Send SolicitOffer with VideoStreams containing invalid VideoStreamID => expect DYNAMIC_CONSTRAINT_ERROR"),
    ...
    @async_test_body
    async def test_TC_WebRTCP_2_27(self):
        """
        Executes the test steps for the WebRTC Provider cluster scenario
        with the multi-stream list API (revision 2).
        """
