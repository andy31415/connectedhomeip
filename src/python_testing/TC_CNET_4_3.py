...
class TC_CNET_4_3(MatterBaseTest):
    ...
    def steps_TC_CNET_4_3(self) -> list[TestStep]:
        return [
            ...
            TestStep(
                3,
                "TH reads the Networks attribute list from the DUT on all endpoints (all network commissioning clusters of the DUT)",
            ...
            TestStep(5, "TH reads LastNetworkingStatus attribute from the DUT", "LastNetworkingStatus attribute value is Success"),
            TestStep(
                6,
    ...
    @run_if_endpoint_matches(
        has_feature(Clusters.NetworkCommissioning, Clusters.NetworkCommissioning.Bitmaps.Feature.kEthernetNetworkInterface)
    )
