...
class TC_WebRTCR_2_1(WEBRTCRTestBase):
    ...
    def desc_TC_WebRTCR_2_1(self) -> str:
        """Returns a description of this test"""
        return "[TC-{picsCode}-2.1] Validate Offer command with invalid session id"

    def steps_TC_WebRTCR_2_1(self) -> list[TestStep]:
        """
    ...
    def pics_TC_WebRTCR_2_1(self) -> list[str]:
        """
    ...
    async def test_TC_WebRTCR_2_1(self):
        ...
        self.step(4)
        log.info("Injecting kFault_ModifyWebRTCOfferSessionId on TH_SERVER")
