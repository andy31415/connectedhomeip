...
class TC_SETRF_3_1(CommodityTariffTestBaseHelper):
    ...
    def steps_TC_SETRF_3_1(self) -> list[TestStep]:
        return [
            ...
            TestStep(
                "2",
                "Set up a subscription to the Commodity Tariff cluster attributes: MinIntervalFloor: 0, MaxIntervalCeiling: 10",
            ...
            TestStep(
                "22", "TH reads TestEventTriggersEnabled attribute from General Diagnostics Cluster.", "Value has to be 1 (True)."
            ),
            TestStep(
                "23",
                "TH sends TestEventTrigger command to General Diagnostics Cluster on Endpoint 0 with EnableKey field set to PIXIT.SETRF.TEST_EVENT_TRIGGER_KEY and EventTrigger field set to PIXIT.SETRF.TEST_EVENT_TRIGGER for Attributes Value Set Test Event.",
                "Verify DUT responds w/ status SUCCESS(0x00).",
            ),
            TestStep(
                "24",
                "TH awaits a ReportDataMessage from DUT containing a TariffInfo attribute with 10s timeout.",
                """
                     - Verify that the DUT response contains a null or a value of TariffInformationStruct type;
            ...
            TestStep(
                "25",
                "TH awaits a ReportDataMessage from DUT containing a TariffUnit attribute with 10s timeout.",
                """
            ...
            TestStep(
                "43",
                "TH sends TestEventTrigger command to General Diagnostics Cluster on Endpoint 0 with EnableKey field set to PIXIT.SETRF.TEST_EVENT_TRIGGER_KEY and EventTrigger field set to PIXIT.SETRF.TEST_EVENT_TRIGGER for Test Event Clear.",
                """
                     Verify  DUT  responds  w/  status SUCCESS(0x00).""",
            ),
            TestStep(
                "44",
                "TH removes the subscription the Commodity Tariff cluster.",
                """
    ...
    async def test_TC_SETRF_3_1(self):
        ...
        TariffInfoValue = await self.read_single_attribute_check_success(
        ...
        TariffUnitValue = await self.read_single_attribute_check_success(
        ...
        StartDateValue = await self.read_single_attribute_check_success(
        ...
        IndividualDaysValue = await self.read_single_attribute_check_success(
        ...
        DayEntriesValue = await self.read_single_attribute_check_success(
        ...
        DayPatternsValue = await self.read_single_attribute_check_success(
        ...
        CalendarPeriodsValue = await self.read_single_attribute_check_success(
        ...
        CurrentDayValue = await self.read_single_attribute_check_success(
        ...
        NextDayValue = await self.read_single_attribute_check_success(
        ...
        CurrentDayEntryValue = await self.read_single_attribute_check_success(
        ...
        CurrentDayEntryDateValue = await self.read_single_attribute_check_success(
        ...
        NextDayEntryValue = await self.read_single_attribute_check_success(
        ...
        NextDayEntryDateValue = await self.read_single_attribute_check_success(
        ...
        TariffComponentsValue = await self.read_single_attribute_check_success(
        ...
        TariffPeriodsValue = await self.read_single_attribute_check_success(
        ...
        CurrentTariffComponentsValue = await self.read_single_attribute_check_success(
        ...
        NextTariffComponentsValue = await self.read_single_attribute_check_success(
        ...
        if await self.attribute_guard(endpoint=endpoint, attribute=cluster.Attributes.DefaultRandomizationType):
            ...
            DefaultRandomizationTypeValue = await self.read_single_attribute_check_success(
        ...
        if await self.attribute_guard(endpoint=endpoint, attribute=cluster.Attributes.DefaultRandomizationOffset):
            ...
            DefaultRandomizationOffsetValue = await self.read_single_attribute_check_success(
        ...
        await self.verify_reporting(
            subscription_handler.attribute_reports, cluster.Attributes.TariffInfo, "TariffInfo", TariffInfoValue
        )
        ...
        await self.verify_reporting(
            subscription_handler.attribute_reports, cluster.Attributes.TariffUnit, "TariffUnit", TariffUnitValue
        )
        ...
        await self.verify_reporting(
            subscription_handler.attribute_reports, cluster.Attributes.StartDate, "StartDate", StartDateValue
        )
        ...
        await self.verify_reporting(
            subscription_handler.attribute_reports, cluster.Attributes.IndividualDays, "IndividualDays", IndividualDaysValue
        )
        ...
        await self.verify_reporting(
            subscription_handler.attribute_reports, cluster.Attributes.DayEntries, "DayEntries", DayEntriesValue
        )
        ...
        await self.verify_reporting(
            subscription_handler.attribute_reports, cluster.Attributes.DayPatterns, "DayPatterns", DayPatternsValue
        )
        ...
        await self.verify_reporting(
            subscription_handler.attribute_reports, cluster.Attributes.CalendarPeriods, "CalendarPeriods", CalendarPeriodsValue
        )
        ...
        await self.verify_reporting(
            subscription_handler.attribute_reports, cluster.Attributes.CurrentDay, "CurrentDay", CurrentDayValue
        )
        ...
        await self.verify_reporting(
            subscription_handler.attribute_reports, cluster.Attributes.CurrentDayEntry, "CurrentDayEntry", CurrentDayEntryValue
        )
        ...
        await self.verify_reporting(
            subscription_handler.attribute_reports,
            cluster.Attributes.CurrentDayEntryDate,
            "CurrentDayEntryDate",
            CurrentDayEntryDateValue,
        )
        ...
        await self.verify_reporting(
            subscription_handler.attribute_reports, cluster.Attributes.NextDayEntry, "NextDayEntry", NextDayEntryValue
        )
        ...
        await self.verify_reporting(
            subscription_handler.attribute_reports, cluster.Attributes.NextDayEntryDate, "NextDayEntryDate", NextDayEntryDateValue
        )
        ...
        await self.verify_reporting(
            subscription_handler.attribute_reports, cluster.Attributes.TariffComponents, "TariffComponents", TariffComponentsValue
        )
        ...
        await self.verify_reporting(
            subscription_handler.attribute_reports, cluster.Attributes.TariffPeriods, "TariffPeriods", TariffPeriodsValue
        )
        ...
        await self.verify_reporting(
            subscription_handler.attribute_reports,
            cluster.Attributes.CurrentTariffComponents,
            "CurrentTariffComponents",
            CurrentTariffComponentsValue,
        )
        ...
        await self.verify_reporting(
            subscription_handler.attribute_reports,
            cluster.Attributes.NextTariffComponents,
            "NextTariffComponents",
            NextTariffComponentsValue,
        )
        ...
        if await self.attribute_guard(endpoint=endpoint, attribute=cluster.Attributes.DefaultRandomizationType):
            ...
            await self.verify_reporting(
                subscription_handler.attribute_reports,
                cluster.Attributes.DefaultRandomizationType,
                "DefaultRandomizationType",
                DefaultRandomizationTypeValue,
            )
        else:
            if self.check_pics("SETRF.S.A0012"):  # for cases when it is not supported by DUT, but enabled in PICS
                self.step("41")
        ...
        if await self.attribute_guard(endpoint=endpoint, attribute=cluster.Attributes.DefaultRandomizationOffset):
            ...
            await self.verify_reporting(
                subscription_handler.attribute_reports,
                cluster.Attributes.DefaultRandomizationOffset,
                "DefaultRandomizationOffset",
                DefaultRandomizationOffsetValue,
            )
        else:
            if self.check_pics("SETRF.S.A0011"):  # for cases when it is not supported by DUT, but enabled in PICS
                self.step("42")
