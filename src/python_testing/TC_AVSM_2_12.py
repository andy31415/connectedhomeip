...
class TC_AVSM_2_12(MatterBaseTest):
    ...
    def steps_TC_AVSM_2_12(self) -> list[TestStep]:
        return [
            ...
            TestStep(
                2,
                "TH reads HDRModeEnabled attribute.",
                "Verify that the DUT response contains a bool value. Store value as aHDREnabled",
            ),
            TestStep(
                3, "TH writes HDRModeEnabled attribute with value set to !aHDREnabled.", "DUT responds with a SUCCESS status code."
            ),
            TestStep(4, "TH reads HDRModeEnabled attribute.", "Verify that the value is the same as was written in Step 3."),
            TestStep(
                5,
                "TH reads SoftRecordingPrivacyModeEnabled attribute.",
                "Verify that the DUT response contains a bool value. Store value as aSoftRecordingPrivacyMode",
            ),
            TestStep(
                6,
                "TH writes SoftRecordingPrivacyModeEnabled attribute with value set to !aSoftRecordingPrivacyMode.",
            ...
            TestStep(
                8,
                "TH reads SoftLivestreamPrivacyModeEnabled attribute.",
                "Verify that the DUT response contains a bool value. Store value as aSoftLivestreamPrivacyMode",
            ),
            TestStep(
                9,
                "TH writes SoftLivestreamPrivacyModeEnabled attribute with value set to !aSoftLivestreamPrivacyMode.",
                "DUT responds with a SUCCESS status code.",
            ),
            TestStep(
                10,
            ...
            TestStep(
                11,
                "TH reads NightVision attribute.",
            ...
            TestStep(
                14,
                "TH reads NightVisionIllum attribute.",
            ...
            TestStep(
                20,
                "TH reads SpeakerMuted attribute.",
                "Verify that the DUT response contains a bool value. Store value as aSpeakerMuted",
            ),
            TestStep(
                21, "TH writes SpeakerMuted attribute with value set to !aSpeakerMuted.", "DUT responds with a SUCCESS status code."
            ),
            TestStep(22, "TH reads SpeakerMuted attribute.", "Verify that the value is the same as was written in Step 21."),
            TestStep(
                23,
                "TH reads SpeakerVolumeLevel attribute.",
                "Verify that the DUT response is in the range SpeakerMin to SpeakerMax. Store value as aSpeakerVolumeLevel",
            ),
            TestStep(
                24,
                "TH writes SpeakerVolumeLevel attribute with a new value of aSpeakerVolumeLevel.",
                "DUT responds with a SUCCESS status code.",
            ),
            TestStep(25, "TH reads SpeakerVolumeLevel attribute.", "Verify that the value is the same as was written in Step 24."),
            TestStep(
                26,
                "TH reads MicrophoneMuted attribute.",
                "Verify that the DUT response contains a bool value. Store value as aMicrophoneMuted",
            ),
            TestStep(
                27,
                "TH writes MicrophoneMuted attribute with value set to !aMicrophoneMuted.",
                "DUT responds with a SUCCESS status code.",
            ),
            TestStep(28, "TH reads MicrophoneMuted attribute.", "Verify that the value is the same as was written in Step 27."),
            TestStep(
                29,
                "TH reads MicrophoneVolumeLevel attribute.",
                "Verify that the DUT response is in the range MicrophoneMin to MicrophoneMax. Store value as aMicrophoneVolumeLevel",
            ),
            TestStep(
                30,
                "TH writes MicrophoneVolumeLevel attribute with a new value of aMicrophoneVolumeLevel.",
                "DUT responds with a SUCCESS status code.",
            ),
            TestStep(
                31, "TH reads MicrophoneVolumeLevel attribute.", "Verify that the value is the same as was written in Step 30."
            ),
            TestStep(
                32,
                "TH reads MicrophoneAGCEnabled attribute.",
                "Verify that the DUT response contains a bool value. Store value as aMicrophoneAGCEnabled",
            ),
            TestStep(
                33,
                "TH writes MicrophoneAGCEnabled attribute with value set to !aMicrophoneAGCEnabled.",
                "DUT responds with a SUCCESS status code.",
            ),
            TestStep(
                34, "TH reads MicrophoneAGCEnabled attribute.", "Verify that the value is the same as was written in Step 33."
            ),
            TestStep(
                35,
                "TH reads ImageRotation attribute.",
                "Verify that the DUT response is not greater than 359. Store value as aImageRotation",
            ),
            TestStep(
                36,
                "TH writes ImageRotation attribute with a new value of aImageRotation.",
                "DUT responds with a SUCCESS status code.",
            ),
            TestStep(37, "TH reads ImageRotation attribute.", "Verify that the value is the same as was written in Step 36."),
            TestStep(
                38,
                "TH reads ImageFlipHorizontal attribute.",
                "Verify that the DUT response contains a bool value. Store value as aImageFlipHorizontal",
            ),
            TestStep(
                39,
                "TH writes ImageFlipHorizontal attribute with value set to !aImageFlipHorizontal.",
                "DUT responds with a SUCCESS status code.",
            ),
            TestStep(40, "TH reads ImageFlipHorizontal attribute.", "Verify that the value is the same as was written in Step 39."),
            TestStep(
                41,
                "TH reads ImageFlipVertical attribute.",
                "Verify that the DUT response contains a bool value. Store value as aImageFlipVertical",
            ),
            TestStep(
                42,
                "TH writes ImageFlipVertical attribute with value set to !aImageFlipVertical.",
                "DUT responds with a SUCCESS status code.",
            ),
            TestStep(43, "TH reads ImageFlipVertical attribute.", "Verify that the value is the same as was written in Step 42."),
            TestStep(
                44,
                "TH reads LocalVideoRecordingEnabled attribute.",
                "Verify that the DUT response contains a bool value. Store value as aLocalVideoRecordingEnabled",
            ),
            TestStep(
                45,
                "TH writes LocalVideoRecordingEnabled attribute with value set to !aLocalVideoRecordingEnabled.",
                "DUT responds with a SUCCESS status code.",
            ),
            TestStep(
                46, "TH reads LocalVideoRecordingEnabled attribute.", "Verify that the value is the same as was written in Step 45."
            ),
            TestStep(
                47,
                "TH reads LocalSnapshotRecordingEnabled attribute.",
                "Verify that the DUT response contains a bool value. Store value as aLocalSnapshotRecordingEnabled",
            ),
            TestStep(
                48,
                "TH writes LocalSnapshotRecordingEnabled attribute with value set to !aLocalSnapshotRecordingEnabled.",
                "DUT responds with a SUCCESS status code.",
            ),
            TestStep(
                49,
            ...
            TestStep(
                50,
                "TH reads StatusLightEnabled attribute.",
                "Verify that the DUT response contains a bool value. Store value as aStatusLightEnabled",
            ),
            TestStep(
                51,
                "TH writes StatusLightEnabled attribute with value set to !aStatusLightEnabled.",
                "DUT responds with a SUCCESS status code.",
            ),
            TestStep(52, "TH reads StatusLightEnabled attribute.", "Verify that the value is the same as was written in Step 51."),
            TestStep(
                53,
                "TH reads StatusLightBrightness attribute.",
                "Verify that the DUT response contains a ThreeLevelAutoEnum value. Store value as aStatusLightBrightness",
            ),
            TestStep(
                54,
                "TH writes StatusLightBrightness attribute with a new valud enum value.",
                "DUT responds with a SUCCESS status code.",
            ),
            TestStep(
                55, "TH reads StatusLightBrightness attribute.", "Verify that the value is the same as was written in Step 54."
            ),
        ]
    ...
    async def test_TC_AVSM_2_12(self):
        ...
        if self.hdrSupported:
            ...
            self.step(3)
            result = await self.write_single_attribute(attr.HDRModeEnabled(not hdrEnabled), endpoint_id=endpoint)
        ...
        if self.privSupported:
            ...
            result = await self.write_single_attribute(
                attr.SoftRecordingPrivacyModeEnabled(not softRecordingPrivMode), endpoint_id=endpoint
            )
            ...
            asserts.assert_equal(
                softRecordingPrivModeNew, not softRecordingPrivMode, "Value does not match what was written in step 6"
            )
            ...
            self.step(9)
            result = await self.write_single_attribute(
                attr.SoftLivestreamPrivacyModeEnabled(not softLivestreamPrivMode), endpoint_id=endpoint
            )
            ...
            asserts.assert_equal(
                softLivestreamPrivModeNew, not softLivestreamPrivMode, "Value does not match what was written in step 9"
            )
        else:
        ...
        if self.nightVisionSupported:
            ...
            result = await self.write_single_attribute(attr.NightVision(nightVisionToWrite), endpoint_id=endpoint)
            ...
            if await self.attribute_guard(endpoint=endpoint, attribute=attr.NightVisionIllum):
                ...
                result = await self.write_single_attribute(attr.NightVisionIllum(nightVisionIllumToWrite), endpoint_id=endpoint)
        ...
        if self.vdoSupported:
            ...
            result = await self.write_single_attribute(attr.Viewport(viewportToWrite), endpoint_id=endpoint)
        ...
        if self.speakerSupported:
            ...
            self.step(21)
            result = await self.write_single_attribute(attr.SpeakerMuted(not speakerMuted), endpoint_id=endpoint)
            ...
            if speakerMinLevel < speakerMaxLevel:
                ...
                matter_asserts.assert_int_in_range(
                    speakerVolumeLevel, speakerMinLevel, speakerMaxLevel, "Speaker Volume not between SpeakerMin and SpeakerMax"
                )
                ...
                result = await self.write_single_attribute(attr.SpeakerVolumeLevel(newSpeakerVolume), endpoint_id=endpoint)
        ...
        if self.adoSupported:
            ...
            self.step(27)
            result = await self.write_single_attribute(attr.MicrophoneMuted(not micMuted), endpoint_id=endpoint)
            ...
            if micMinLevel < micMaxLevel:
                ...
                matter_asserts.assert_int_in_range(
                    micVolumeLevel, micMinLevel, micMaxLevel, "Microphone Volume not between MicMin and MicMax"
                )
                ...
                result = await self.write_single_attribute(attr.MicrophoneVolumeLevel(newMicVolume), endpoint_id=endpoint)
                ...
                asserts.assert_equal(
                    micVolumeLevelNew, newMicVolume, "Value does not match what was written for MicrophoneVolumeLevel in step 30"
                )
            else:
                self.skip_step(29)
                self.skip_step(30)
            ...
            if await self.attribute_guard(endpoint=endpoint, attribute=attr.MicrophoneAGCEnabled):
                ...
                self.step(33)
                result = await self.write_single_attribute(attr.MicrophoneAGCEnabled(not micAGCEnabled), endpoint_id=endpoint)
                ...
                asserts.assert_equal(
                    micAGCEnabledNew, not micAGCEnabled, "Value does not match what was written for MicrophoneAGCEnabled in step 33"
                )
            else:
                self.skip_step(32)
                self.skip_step(33)
        ...
        if self.imagecControlSupported:
            ...
            if await self.attribute_guard(endpoint=endpoint, attribute=attr.ImageRotation):
                self.step(35)
                imageRotation = await self.read_single_attribute_check_success(
                ...
                result = await self.write_single_attribute(attr.ImageRotation(newImageRotation), endpoint_id=endpoint)
                ...
                asserts.assert_equal(
                    imageRotationNew, newImageRotation, "Value does not match what was written for ImageRotation in step 36"
                )
            ...
            if await self.attribute_guard(endpoint=endpoint, attribute=attr.ImageFlipHorizontal):
                ...
                self.step(39)
                result = await self.write_single_attribute(attr.ImageFlipHorizontal(not imageFlipHorizontal), endpoint_id=endpoint)
                ...
                asserts.assert_equal(
                    imageFlipHorizontalNew,
                    not imageFlipHorizontal,
            ...
            if await self.attribute_guard(endpoint=endpoint, attribute=attr.ImageFlipVertical):
                ...
                self.step(42)
                result = await self.write_single_attribute(attr.ImageFlipVertical(not imageFlipVertical), endpoint_id=endpoint)
                ...
                asserts.assert_equal(
                    imageFlipVerticalNew,
                    not imageFlipVertical,
        ...
        if self.vdoSupported and self.localStorageSupported:
            ...
            self.step(45)
            result = await self.write_single_attribute(
                attr.LocalVideoRecordingEnabled(not localVideoRecordingEnabled), endpoint_id=endpoint
            )
            ...
            asserts.assert_equal(
                localVideoRecordingEnabledNew,
                not localVideoRecordingEnabled,
        ...
        if self.snapshotSupported and self.localStorageSupported:
            ...
            self.step(48)
            result = await self.write_single_attribute(
                attr.LocalSnapshotRecordingEnabled(not localSnapshotRecordingEnabled), endpoint_id=endpoint
            )
            ...
            asserts.assert_equal(
                localSnapshotRecordingEnabledNew,
                not localSnapshotRecordingEnabled,
        ...
        if await self.attribute_guard(endpoint=endpoint, attribute=attr.StatusLightEnabled):
            ...
            self.step(51)
            result = await self.write_single_attribute(attr.StatusLightEnabled(not statusLightEnabled), endpoint_id=endpoint)
            ...
            asserts.assert_equal(
                statusLightEnabledNew,
                not statusLightEnabled,
        ...
        if await self.attribute_guard(endpoint=endpoint, attribute=attr.StatusLightBrightness):
            ...
            result = await self.write_single_attribute(
                attr.StatusLightBrightness(statusLightBrightnessToWrite), endpoint_id=endpoint
            )
            ...
            asserts.assert_equal(
                statusLightBrightnessNew,
                statusLightBrightnessToWrite,
