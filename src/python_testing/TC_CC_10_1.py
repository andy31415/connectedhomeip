...
class TC_CC_10_1(MatterBaseTest):
    ...
    #
    def _prepare_cc_extension_field_set(
        self, attribute_value_list: List[Clusters.ScenesManagement.Structs.AttributeValuePairStruct]
        ...
        return Clusters.ScenesManagement.Structs.ExtensionFieldSetStruct(
            clusterID=Clusters.Objects.ColorControl.id, attributeValueList=efs_attribute_value_list
        )
    ...
    def steps_TC_CC_10_1(self) -> list[TestStep]:
        return [
            ...
            TestStep(
                "0a",
                "TH sends KeySetWrite command in the GroupKeyManagement cluster to DUT using a key that is pre-installed on the TH. GroupKeySet fields are as follows: GroupKeySetID: 0x01a1, GroupKeySecurityPolicy: TrustFirst (0), EpochKey0: a0a1a2a3a4a5a6a7a8a9aaabacadaeaf, EpochStartTime0: 1110000",
            ),
            TestStep(
                "0b",
                "If the Groupcast cluster is enabled on the root node, skip this step. Otherwise, TH binds GroupIds 0x0001 with GroupKeySetID 0x01a1 in the GroupKeyMap attribute list on GroupKeyManagement cluster.",
            ),
            TestStep(
                "0c",
            ...
            TestStep(
                "1a",
                "If the Groupcast cluster is enabled on the RootNode endpoint, the TH sends Groupcast JoinGroup command with GroupID 1, Endpoints set with the EndpointId, where ColorControl cluster is enabled, and KeySetID 0x01a1 to DUT. Otherwise, TH sends AddGroup command to DUT, with the GroupID field set to 1.",
            ),
            ...
            TestStep(
                "2a",
                "TH sends _MoveToHueAndSaturation command_ to DUT with _Hue_=200, _Saturation_=50 and _TransitionTime_=0 (immediately).",
            ),
            TestStep("2b", "TH reads _CurrentHue and CurrentSaturation attributes_ from DUT."),
            TestStep(
                "2c",
                "TH sends a _StoreScene_ command to DUT with the _GroupID_ field set to _G~1~_ and the _SceneID_ field set to 0x01.",
            ),
            TestStep(
                "2d",
                "TH sends a _ViewScene_ command to DUT with the _GroupID_ field set to _G~1~_ and the _SceneID_ field set to 0x01.",
            ),
            TestStep(
                "3a",
                "TH sends _MoveToColor command_ to DUT, with: ColorX = 32768/0x8000 (x=0.5) (purple), ColorY = 19660/0x4CCC (y=0.3), TransitionTime = 0 (immediate)",
            ),
            ...
            TestStep(
                "4a",
                "TH sends _MoveToColorTemperature command_ to DUT with _ColorTemperatureMireds_=(_ColorTempPhysicalMinMireds_ + _ColorTempPhysicalMaxMireds_)/2",
            ),
            ...
            TestStep(
                "5a",
                "TH sends _EnhancedMoveToHueAndSaturation command_ to DUT with _EnhancedHue_=20000, _Saturation_=50 and _TransitionTime_=0 (immediately).",
            ),
            ...
            TestStep(
                "6a",
                "TH sends a _AddScene_ command to DUT with the _GroupID_ field set to _G~1~_, the _SceneID_ field set to 0x02, the TransitionTime field set to 0 and the ExtensionFieldSetStructs set to: '[{ ClusterID: 0x0300, AttributeValueList: [{ AttributeID: 0x4001, ValueUnsigned8: 0x00 }, { AttributeID: 0x0001, ValueUnsigned8: 0xE0 }]}]'",
            ),
            TestStep(
                "6b",
                "TH sends a _RecallScene_ command to DUT with the _GroupID_ field set to _G~1~_, the _SceneID_ field set to 0x02 and the _TransitionTime_ omitted.",
            ),
            TestStep("6c", "TH reads the _CurrentSaturation attribute_ from DUT."),
            TestStep(
                "7a",
                "TH sends a _AddScene_ command to DUT with the _GroupID_ field set to _G~1~_, the _SceneID_ field set to 0x03, the TransitionTime field set to 0 and the ExtensionFieldSetStructs set to: '[{ ClusterID: 0x0300, AttributeValueList: [{ AttributeID: 0x4001, ValueUnsigned8: 0x01 }, { AttributeID: 0x0003, ValueUnsigned16: 16334 },{ AttributeID: 0x0004, ValueUnsigned16: 13067 }]}]'",
            ),
            TestStep(
                "7b",
                "TH sends a _RecallScene_ command to DUT with the _GroupID_ field set to _G~1~_, the _SceneID_ field set to 0x03 and the _TransitionTime_ omitted.",
            ),
            TestStep("7c", "TH reads _CurrentX and CurrentY attributes_ from DUT."),
            TestStep(
                "8a",
                "TH sends a _AddScene_ command to DUT with the _GroupID_ field set to _G~1~_, the _SceneID_ field set to 0x04, the TransitionTime field set to 0 and the ExtensionFieldSetStructs set to: '[{ ClusterID: 0x0300, AttributeValueList: [{ AttributeID: 0x4001, ValueUnsigned8: 0x02 }, { AttributeID: 0x0007, ValueUnsigned16: 250 }]}]'",
            ),
            TestStep(
                "8b",
                "TH sends a _RecallScene_ command to DUT with the _GroupID_ field set to _G~1~_, the _SceneID_ field set to 0x04 and the _TransitionTime_ omitted.",
            ),
            ...
            TestStep(
                "9b",
                "TH sends a _RecallScene_ command to DUT with the _GroupID_ field set to _G~1~_, the _SceneID_ field set to 0x05 and the _TransitionTime_ omitted.",
            ),
            ...
            TestStep(
                "10b",
                "TH sends a _RecallScene_ command to DUT with the _GroupID_ field set to _G~1~_, the _SceneID_ field set to 0x06 and the _TransitionTime_ omitted.",
            ),
    ...
    async def test_TC_CC_10_1(self):
        ...
        if self.pics_guard(self.check_pics("CC.S.F04")):
            ColorTempPhysicalMinMiredsValue = await self.read_single_attribute_check_success(
                cluster, attributes.ColorTempPhysicalMinMireds
            )

        self.step("1e")
        if self.pics_guard(self.check_pics("CC.S.F04")):
            ColorTempPhysicalMaxMiredsValue = await self.read_single_attribute_check_success(
                cluster, attributes.ColorTempPhysicalMaxMireds
            )

        self.step("2a")
        if self.pics_guard(self.check_pics("CC.S.F00")):
            await self.TH1.SendCommand(
                self.dut_node_id, self.matter_test_config.endpoint, cluster.Commands.MoveToHueAndSaturation(200, 50, 0, 1, 1)
            )
        ...
        if self.pics_guard(self.check_pics("CC.S.F00")):
            result = await self.TH1.ReadAttribute(
                self.dut_node_id,
                [
                    (self.matter_test_config.endpoint, attributes.CurrentHue),
                    (self.matter_test_config.endpoint, attributes.CurrentSaturation),
                ],
            )
            asserts.assert_less_equal(
                result[self.matter_test_config.endpoint][cluster][attributes.CurrentHue],
                230,
                "CurrentHue is not less than or equal to 230",
            )
            ...
            asserts.assert_less_equal(
                result[self.matter_test_config.endpoint][cluster][attributes.CurrentSaturation],
                58,
                "CurrentSaturation is not less than or equal 58",
            )
            asserts.assert_greater_equal(
                result[self.matter_test_config.endpoint][cluster][attributes.CurrentSaturation],
                42,
                "CurrentSaturation is not greater than or equal 42",
            )
        ...
        if self.pics_guard(self.check_pics("CC.S.F00")):
            result = await self.TH1.SendCommand(
                ...
                Clusters.ScenesManagement.Commands.StoreScene(self.kGroup1, 0x01),
            )
        ...
        if self.pics_guard(self.check_pics("CC.S.F00")):
            result = await self.TH1.SendCommand(
                self.dut_node_id, self.matter_test_config.endpoint, Clusters.ScenesManagement.Commands.ViewScene(self.kGroup1, 0x01)
            )
        ...
        if self.pics_guard(self.check_pics("CC.S.F03")):
            await self.TH1.SendCommand(
                self.dut_node_id, self.matter_test_config.endpoint, cluster.Commands.MoveToColor(32768, 19660, 0, 1, 1)
            )
            await asyncio.sleep(1)
        ...
        if self.pics_guard(self.check_pics("CC.S.F03")):
            result = await self.TH1.ReadAttribute(
                self.dut_node_id,
                [(self.matter_test_config.endpoint, attributes.CurrentX), (self.matter_test_config.endpoint, attributes.CurrentY)],
            )
            asserts.assert_less_equal(
                result[self.matter_test_config.endpoint][cluster][attributes.CurrentX],
                35000,
                "CurrentX is not less than or equal to 35000",
            )
            asserts.assert_greater_equal(
                result[self.matter_test_config.endpoint][cluster][attributes.CurrentX],
                31000,
            ...
            asserts.assert_less_equal(
                result[self.matter_test_config.endpoint][cluster][attributes.CurrentY],
                21000,
                "CurrentY is not less than or equal to 21000",
            )
            asserts.assert_greater_equal(
                result[self.matter_test_config.endpoint][cluster][attributes.CurrentY],
                17000,
        ...
        if self.pics_guard(self.check_pics("CC.S.F04")):
            ...
            await self.TH1.SendCommand(
                self.dut_node_id, self.matter_test_config.endpoint, cluster.Commands.MoveToColorTemperature(CTtarget, 0, 1, 1)
            )
            await asyncio.sleep(1)
        ...
        if self.pics_guard(self.check_pics("CC.S.F04")):
            ...
            result = await self.TH1.ReadAttribute(
                self.dut_node_id, [(self.matter_test_config.endpoint, attributes.ColorTemperatureMireds)]
            )
            asserts.assert_less_equal(
                result[self.matter_test_config.endpoint][cluster][attributes.ColorTemperatureMireds],
                CTmax,
        ...
        if self.pics_guard(self.check_pics("CC.S.F01")):
            await self.TH1.SendCommand(
                self.dut_node_id,
                self.matter_test_config.endpoint,
                cluster.Commands.EnhancedMoveToHueAndSaturation(20000, 50, 0, 1, 1),
            )
            await asyncio.sleep(1)
        ...
        if self.pics_guard(self.check_pics("CC.S.F01")):
            result = await self.TH1.ReadAttribute(
                self.dut_node_id,
                [
                    (self.matter_test_config.endpoint, attributes.EnhancedCurrentHue),
                    (self.matter_test_config.endpoint, attributes.CurrentSaturation),
                ],
            )
            asserts.assert_less_equal(
                result[self.matter_test_config.endpoint][cluster][attributes.EnhancedCurrentHue],
                21800,
            ...
            asserts.assert_less_equal(
                result[self.matter_test_config.endpoint][cluster][attributes.CurrentSaturation], 58, "CurrentSaturation is not 58"
            )
            asserts.assert_greater_equal(
                result[self.matter_test_config.endpoint][cluster][attributes.CurrentSaturation], 42, "CurrentSaturation is not 42"
            )
        ...
        if self.pics_guard(self.check_pics("CC.S.F00")):
            await self.TH1.SendCommand(
                self.dut_node_id,
                self.matter_test_config.endpoint,
                Clusters.ScenesManagement.Commands.RecallScene(self.kGroup1, 0x02),
            )
        ...
        if self.pics_guard(self.check_pics("CC.S.F03")):
            await self.TH1.SendCommand(
                self.dut_node_id,
                self.matter_test_config.endpoint,
                Clusters.ScenesManagement.Commands.RecallScene(self.kGroup1, 0x03),
            )
        ...
        if self.pics_guard(self.check_pics("CC.S.F03")):
            ...
            asserts.assert_less_equal(
                result[self.matter_test_config.endpoint][cluster][attributes.CurrentX], 18000, "CurrentX is above limit"
            )
            asserts.assert_greater_equal(
                result[self.matter_test_config.endpoint][cluster][attributes.CurrentX], 14000, "CurrentX is below limit"
            )
            asserts.assert_less_equal(
                result[self.matter_test_config.endpoint][cluster][attributes.CurrentY], 15000, "CurrentY is above limit"
            )
            asserts.assert_greater_equal(
                result[self.matter_test_config.endpoint][cluster][attributes.CurrentY], 11000, "CurrentY is below limit"
            )
        ...
        if self.pics_guard(self.check_pics("CC.S.F04")):
            await self.TH1.SendCommand(
                self.dut_node_id,
                self.matter_test_config.endpoint,
                Clusters.ScenesManagement.Commands.RecallScene(self.kGroup1, 0x04),
            )
        ...
        if self.pics_guard(self.check_pics("CC.S.F04")):
            ...
            asserts.assert_less_equal(
                ColorTemperatureMireds, ColorTempPhysicalMaxMiredsValue, "ColorTemperatureMireds is above limit"
            )
            asserts.assert_greater_equal(
                ColorTemperatureMireds, ColorTempPhysicalMinMiredsValue, "ColorTemperatureMireds is below limit"
            )
        ...
        if self.pics_guard(self.check_pics("CC.S.F01")):
            await self.TH1.SendCommand(
                self.dut_node_id,
                self.matter_test_config.endpoint,
                Clusters.ScenesManagement.Commands.RecallScene(self.kGroup1, 0x05),
            )
        ...
        if self.pics_guard(self.check_pics("CC.S.F01")):
            ...
            asserts.assert_less_equal(
                result[self.matter_test_config.endpoint][cluster][attributes.EnhancedCurrentHue],
                13800,
                "EnhancedCurrentHue is above limit",
            )
            asserts.assert_greater_equal(
                result[self.matter_test_config.endpoint][cluster][attributes.EnhancedCurrentHue],
                10200,
                "EnhancedCurrentHue is below limit",
            )
            asserts.assert_less_equal(
                result[self.matter_test_config.endpoint][cluster][attributes.CurrentSaturation],
                78,
                "CurrentSaturation is above limit",
            )
            asserts.assert_greater_equal(
                result[self.matter_test_config.endpoint][cluster][attributes.CurrentSaturation],
                62,
                "CurrentSaturation is below limit",
            )
        ...
        if self.pics_guard(self.check_pics("CC.S.F02")):
            await self.TH1.SendCommand(
                self.dut_node_id,
                self.matter_test_config.endpoint,
                Clusters.ScenesManagement.Commands.RecallScene(self.kGroup1, 0x06),
            )
