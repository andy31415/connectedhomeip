...
class TC_ACL_2_3(MatterBaseTest):
    ...
    async def internal_test_TC_ACL_2_3(self, force_legacy_encoding: bool):
        ...
        ac_extension_value0 = await self.read_single_attribute_check_success(
            endpoint=0, cluster=ac_cluster, attribute=ac_extension_attr
        )
        ...
        extension1 = Clusters.AccessControl.Structs.AccessControlExtensionStruct(data=D_OK_EMPTY)
        ...
        asserts.assert_equal(result1[0].Status, Status.Success, "Write should have succeeded")

        self.step(5)
        # Read AccessControlExtension attribute for TH1 value is D_OK_EMPTY
        ac_extension_value1 = await self.read_single_attribute_check_success(
            endpoint=0, cluster=ac_cluster, attribute=ac_extension_attr
        )
        ...
        extension2 = Clusters.AccessControl.Structs.AccessControlExtensionStruct(data=D_OK_SINGLE)
        ...
        asserts.assert_equal(result2[0].Status, Status.Success, "Write should have succeeded")

        self.step(7)
        # Read AccessControlExtension attribute for TH1 value is D_OK_SINGLE
        ac_extension_value2 = await self.read_single_attribute_check_success(
            endpoint=0, cluster=ac_cluster, attribute=ac_extension_attr
        )
        ...
        extension3 = Clusters.AccessControl.Structs.AccessControlExtensionStruct(data=D_OK_FULL)
        ...
        asserts.assert_equal(result3[0].Status, Status.Success, "Write should have succeeded")

        self.step(9)
        # Read AccessControlExtension attribute for TH1 value is D_OK_FULL
        ac_extension_value3 = await self.read_single_attribute_check_success(
            endpoint=0, cluster=ac_cluster, attribute=ac_extension_attr
        )
        ...
        extension4 = Clusters.AccessControl.Structs.AccessControlExtensionStruct(data=D_BAD_LENGTH)
        ...
        asserts.assert_equal(result4[0].Status, Status.ConstraintError, "Write should have returned a CONSTRAINT_ERROR")

        self.step(11)
        # Write AccessControlExtension attribute for TH1 value is D_BAD_STRUCT
        extension5 = Clusters.AccessControl.Structs.AccessControlExtensionStruct(data=D_BAD_STRUCT)
        ...
        asserts.assert_equal(result5[0].Status, Status.ConstraintError, "Write should have returned a CONSTRAINT_ERROR")

        self.step(12)
        # Write AccessControlExtension attribute for TH1 value is D_BAD_LIST
        extension6 = Clusters.AccessControl.Structs.AccessControlExtensionStruct(data=D_BAD_LIST)
        ...
        asserts.assert_equal(result6[0].Status, Status.ConstraintError, "Write should have returned a CONSTRAINT_ERROR")

        self.step(13)
        # Write AccessControlExtension attribute for TH1 value is D_BAD_ELEM
        extension7 = Clusters.AccessControl.Structs.AccessControlExtensionStruct(data=D_BAD_ELEM)
        ...
        asserts.assert_equal(result7[0].Status, Status.ConstraintError, "Write should have returned a CONSTRAINT_ERROR")

        self.step(14)
        # Write AccessControlExtension attribute for TH1 value is D_BAD_OVERFLOW
        extension8 = Clusters.AccessControl.Structs.AccessControlExtensionStruct(data=D_BAD_OVERFLOW)
        ...
        asserts.assert_equal(result8[0].Status, Status.ConstraintError, "Write should have returned a CONSTRAINT_ERROR")

        self.step(15)
        # Write AccessControlExtension attribute for TH1 value is D_BAD_UNDERFLOW
        extension9 = Clusters.AccessControl.Structs.AccessControlExtensionStruct(data=D_BAD_UNDERFLOW)
        ...
        asserts.assert_equal(result9[0].Status, Status.ConstraintError, "Write should have returned a CONSTRAINT_ERROR")

        self.step(16)
        # Write AccessControlExtension attribute for TH1 value is D_BAD_NONE
        extension10 = Clusters.AccessControl.Structs.AccessControlExtensionStruct(data=D_BAD_NONE)
        ...
        asserts.assert_equal(result10[0].Status, Status.ConstraintError, "Write should have returned a CONSTRAINT_ERROR")

        self.step(17)
        # Write AccessControlExtension attribute for TH1 value is D_OK_EMPTY, D_OK_SINGLE
        extension11 = Clusters.AccessControl.Structs.AccessControlExtensionStruct(data=D_OK_EMPTY)
        extension12 = Clusters.AccessControl.Structs.AccessControlExtensionStruct(data=D_OK_SINGLE)
        ...
        self.step(18)
        # Read AccessControlExtension attribute for TH1 value is D_OK_FULL
        ac_extension_value4 = await self.read_single_attribute_check_success(
            endpoint=0, cluster=ac_cluster, attribute=ac_extension_attr
        )
        ...
        asserts.assert_equal(result12[0].Status, Status.Success, "Write should have returned a SUCCESS")

        self.step(20)
        # Read AccessControlExtension attribute for TH1 value is an empty list
        ac_extension_value5 = await self.read_single_attribute_check_success(
            endpoint=0, cluster=ac_cluster, attribute=ac_extension_attr
        )
    ...
    def steps_TC_ACL_2_3(self) -> list[TestStep]:
        return [
            ...
            TestStep(
                3, "TH1 reads DUT Endpoint 0 AccessControl cluster Extension attribute", "Result is SUCCESS, value is an empty list"
            ),
            TestStep(
                4,
                "TH1 writes DUT Endpoint 0 AccessControl cluster Extension attribute, value is list of AccessControlExtensionStruct containing 1 element struct data field: D_OK_EMPTY",
                "Result is SUCCESS",
            ),
            TestStep(
                5,
            ...
            TestStep(
                6,
                "TH1 writes DUT Endpoint 0 AccessControl cluster Extension attribute, value is list of AccessControlExtensionStruct containing 1 element struct data field: D_OK_SINGLE",
                "Result is SUCCESS",
            ),
            TestStep(
                7,
            ...
            TestStep(
                8,
                "TH1 writes DUT Endpoint 0 AccessControl cluster Extension attribute, value is list of AccessControlExtensionStruct containing 1 element struct data field: D_OK_FULL",
                "Result is SUCCESS",
            ),
            TestStep(
                9,
            ...
            TestStep(
                10,
                "TH1 writes DUT Endpoint 0 AccessControl cluster Extension attribute, value is list of AccessControlExtensionStruct containing 1 element struct data field: D_BAD_LENGTH",
                "Result is CONSTRAINT_ERROR (0x87)",
            ),
            TestStep(
                11,
                "TH1 writes DUT Endpoint 0 AccessControl cluster Extension attribute, value is list of AccessControlExtensionStruct containing 1 element struct data field: D_BAD_STRUCT",
                "Result is CONSTRAINT_ERROR (0x87)",
            ),
            TestStep(
                12,
                "TH1 writes DUT Endpoint 0 AccessControl cluster Extension attribute, value is list of AccessControlExtensionStruct containing 1 element struct data field: D_BAD_LIST",
                "Result is CONSTRAINT_ERROR (0x87)",
            ),
            TestStep(
                13,
                "TH1 writes DUT Endpoint 0 AccessControl cluster Extension attribute, value is list of AccessControlExtensionStruct containing 1 element struct data field: D_BAD_ELEM",
                "Result is CONSTRAINT_ERROR (0x87)",
            ),
            TestStep(
                14,
                "TH1 writes DUT Endpoint 0 AccessControl cluster Extension attribute, value is list of AccessControlExtensionStruct containing 1 element struct data field: D_BAD_OVERFLOW",
                "Result is CONSTRAINT_ERROR (0x87)",
            ),
            TestStep(
                15,
                "TH1 writes DUT Endpoint 0 AccessControl cluster Extension attribute, value is list of AccessControlExtensionStruct containing 1 element struct data field: D_BAD_UNDERFLOW",
                "Result is CONSTRAINT_ERROR (0x87)",
            ),
            TestStep(
                16,
                "TH1 writes DUT Endpoint 0 AccessControl cluster Extension attribute, value is list of AccessControlExtensionStruct containing 1 element struct data field: D_BAD_NONE",
                "Result is CONSTRAINT_ERROR (0x87)",
            ),
            TestStep(
                17,
                "TH1 writes DUT Endpoint 0 AccessControl cluster Extension attribute, value is list of AccessControlExtensionStruct containing 2 elements struct data field: D_OK_EMPTY, D_OK_SINGLE",
