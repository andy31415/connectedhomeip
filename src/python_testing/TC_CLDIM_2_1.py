    ...
    async def test_TC_CLDIM_2_1(self):
        ...
        if current_state is not NullValue:
            asserts.assert_is_instance(
                current_state, Clusters.ClosureDimension.Structs.DimensionStateStruct, "CurrentState is not of expected type"
            )
            if is_positioning_supported:
                asserts.assert_true(
                    current_state.position is NullValue or (0 <= current_state.position <= 10000),
                    "Position is not NullValue or not in the expected range [0:100.00]",
                )
            if is_latching_supported:
                asserts.assert_true(
                    isinstance(current_state.latch, bool) or current_state.latch is NullValue, "Latch is not a boolean or NullValue"
                )
        ...
        if target_state is not NullValue:
            asserts.assert_is_instance(
                target_state, Clusters.ClosureDimension.Structs.DimensionStateStruct, "TargetState is not of expected type"
            )
            if is_positioning_supported:
                asserts.assert_true(
                    target_state.position is NullValue or (0 <= target_state.position <= 10000),
                    "Position is not NullValue or not in the expected range [0:100.00]",
                )
            if is_latching_supported:
                asserts.assert_true(
                    isinstance(target_state.latch, bool) or target_state.latch is NullValue, "Latch is not a boolean or NullValue"
                )
            if is_speed_supported:
                asserts.assert_less(
                    target_state.speed,
        ...
        if is_unit_supported:
            ...
            asserts.assert_less(
                unit,
                Clusters.ClosureDimension.Enums.ClosureUnitEnum.kUnknownEnumValue,
        ...
        if is_unit_supported:
            ...
            if unit_range is not NullValue:
                asserts.assert_is_instance(
                    unit_range, Clusters.ClosureDimension.Structs.UnitRangeStruct, "UnitRange is not of expected type"
                )
                asserts.assert_less(
                    unit,
                    Clusters.ClosureDimension.Enums.ClosureUnitEnum.kUnknownEnumValue,
                ...
                if unit == 0:
                    ...
                    asserts.assert_true(
                        unit_range.min <= unit_range.max <= 32767,
                ...
                if unit == 1:
                    ...
                    asserts.assert_true(
                        unit_range.min <= unit_range.max <= 360, "UnitRange.max is not in the expected range [UnitRange.Min:360]"
                    )
                    asserts.assert_true(
                        1 <= unit_range.max - unit_range.min <= 360,
        ...
        if is_limitation_supported:
            ...
            asserts.assert_is_instance(
                limit_range, Clusters.ClosureDimension.Structs.RangePercent100thsStruct, "LimitRange is not of expected type"
            )
            ...
            asserts.assert_true(
                limit_range.min <= limit_range.max <= 10000, "LimitRange.max is not in the expected range [LimitRange.Min:10000]"
            )
        ...
        if is_translation_supported:
            translation_direction = await self.read_cldim_attribute_expect_success(
                endpoint=endpoint, attribute=attributes.TranslationDirection
            )
            asserts.assert_is_instance(
                translation_direction,
                Clusters.ClosureDimension.Enums.TranslationDirectionEnum,
                "TranslationDirection is not of expected type",
            )
            asserts.assert_less(
                translation_direction,
                Clusters.ClosureDimension.Enums.TranslationDirectionEnum.kUnknownEnumValue,
        ...
        if is_rotation_supported:
            ...
            asserts.assert_is_instance(
                rotation_axis, Clusters.ClosureDimension.Enums.RotationAxisEnum, "RotationAxis is not of expected type"
            )
            asserts.assert_less(
                rotation_axis,
                Clusters.ClosureDimension.Enums.RotationAxisEnum.kUnknownEnumValue,
        ...
        if is_rotation_supported:
            ...
            asserts.assert_less(
                overflow,
                Clusters.ClosureDimension.Enums.OverflowEnum.kUnknownEnumValue,
        ...
        if is_modulation_supported:
            ...
            asserts.assert_is_instance(
                modulation_type, Clusters.ClosureDimension.Enums.ModulationTypeEnum, "ModulationType is not of expected type"
            )
            asserts.assert_less(
                modulation_type,
                Clusters.ClosureDimension.Enums.ModulationTypeEnum.kUnknownEnumValue,
