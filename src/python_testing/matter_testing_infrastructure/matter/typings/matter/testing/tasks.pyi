...
def forward_f(
    f_in: BinaryIO, f_out: BinaryIO, cb: Optional[Callable[[bytes, bool], bytes]] = ..., is_stderr: bool = ...
) -> None: ...
...
class Subprocess(threading.Thread):
    ...
    def run(self) -> None: ...
    def start(self, expected_output: Optional[Union[str, Pattern[bytes]]] = ..., timeout: Optional[float] = ...) -> None: ...
    def send(
        self,
        message: str,
        end: str = ...,
