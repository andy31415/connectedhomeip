...
class TC_PAVST_2_5(MatterBaseTest, PAVSTTestBase, PAVSTIUtils):
    ...
    async def test_TC_PAVST_2_5(self):
        ...
        cmd = pvcluster.Commands.DeallocatePushTransport(connectionID=max_connectionID + 1)
        ...
        asserts.assert_equal(len(transportConfigs), 0, "TransportConfigurations must be empty!")
