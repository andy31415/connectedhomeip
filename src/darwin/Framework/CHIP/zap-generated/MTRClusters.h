...
- (NSDictionary<NSString *, id> *)readAttributeTagListWithParams:(MTRReadParams * _Nullable)params MTR_NEWLY_AVAILABLE;
...
- (NSDictionary<NSString *, id> *)readAttributeEndpointListWithParams:(MTRReadParams * _Nullable)params MTR_NEWLY_AVAILABLE;
...
/**
 * Cluster Custom On/Off One
 *    Attributes and commands for switching devices between 'On' and 'Off' states.
 */
MTR_NEWLY_AVAILABLE
@interface MTRClusterCustomOnOffOne : MTRCluster

- (instancetype _Nullable)initWithDevice:(MTRDevice *)device
                              endpointID:(NSNumber *)endpointID
                                   queue:(dispatch_queue_t)queue NS_DESIGNATED_INITIALIZER MTR_NEWLY_AVAILABLE;

- (NSDictionary<NSString *, id> *)readAttributeOnOffWithParams:(MTRReadParams * _Nullable)params MTR_NEWLY_AVAILABLE;

- (NSDictionary<NSString *, id> *)readAttributeUpDownWithParams:(MTRReadParams * _Nullable)params MTR_NEWLY_AVAILABLE;
...
/**
 * Cluster Custom On/Off Two
 *    Attributes and commands for switching devices between 'On' and 'Off' states.
 */
MTR_NEWLY_AVAILABLE
@interface MTRClusterCustomOnOffTwo : MTRCluster
...
MTR_DEPRECATED(
    "Please use MTRClusterBridgedDeviceBasicInformation", ios(16.1, 17.0), macos(13.0, 14.0), watchos(9.1, 10.0), tvos(16.1, 17.0))
