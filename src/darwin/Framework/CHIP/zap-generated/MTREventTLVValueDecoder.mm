...
static id _Nullable DecodeEventPayloadForCustomOnOffOneCluster(EventId aEventId, TLV::TLVReader & aReader, CHIP_ERROR * aError)
{
...
static id _Nullable DecodeEventPayloadForCustomOnOffTwoCluster(EventId aEventId, TLV::TLVReader & aReader, CHIP_ERROR * aError)
{
...
id _Nullable MTRDecodeEventPayload(const ConcreteEventPath & aPath, TLV::TLVReader & aReader, CHIP_ERROR * aError)
{
    ...
    case Clusters::CustomOnOffOne::Id: {
        return DecodeEventPayloadForCustomOnOffOneCluster(aPath.mEventId, aReader, aError);
    }
    case Clusters::CustomOnOffTwo::Id: {
        return DecodeEventPayloadForCustomOnOffTwoCluster(aPath.mEventId, aReader, aError);
    }
