...
if github["event_name"] == "pull_request":
    ...
    r = subprocess.run(["git", "show", "--no-patch", "--format=%s", "HEAD"], capture_output=True, text=True, check=True)
    ...
    timestamp = dateutil.parser.isoparse(github["event"]["head_commit"]["timestamp"]).timestamp()
