...
def main():
    ...
    parser.add_argument("--device", default="/dev/ttyUSB0", type=str, help="What serial device to open.")

    parser.add_argument("--baudrate", default=115200, type=int, help="Baudrate for the serial device.")

    parser.add_argument("--log-level", default=logging.DEBUG, type=lambda x: getattr(logging, x), help="Log filtering to apply.")
