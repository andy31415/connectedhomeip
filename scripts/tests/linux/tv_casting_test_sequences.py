...
test_sequences = [
    Sequence(
        ...
        steps=[
            ...
            Step(
                app=App.TV_CASTING_APP,
                output_msg=[
                    "Discovered CastingPlayer #0",
                    f"Product ID: {PRODUCT_ID}",
                    f"Vendor ID: {VENDOR_ID}",
                    f"Device Type: {DEVICE_TYPE_CASTING_VIDEO_PLAYER}",
                    "Supports Commissioner Generated Passcode: true",
                ],
            ),
            ...
            Step(
                app=App.TV_CASTING_APP,
                output_msg=["CastingPlayer::VerifyOrEstablishConnection() calling OpenBasicCommissioningWindow()"],
            ),
        ...
        steps=[
            ...
            Step(
                ...
                output_msg=[
                    ...
                    "IdentificationDeclarationOptions::mCommissionerPasscode:      true",
                    "IdentificationDeclarationOptions::mCommissionerPasscodeReady: false",
                    "IdentificationDeclarationOptions::TargetAppInfos list:",
                    f"TargetAppInfo 1, Vendor ID: {VENDOR_ID}",
                ],
            ),
            # Validate that we received the cast request from the tv-casting-app on the tv-app output.
            Step(
            ...
            Step(
                app=App.TV_APP,
                output_msg=["Commissioner Declaration Start", "commissioner passcode: true", "Commissioner Declaration End"],
            ),
            ...
            Step(
                ...
                output_msg=[
                    "Awaiting user input",
                    "Input the Commissioner-Generated passcode displayed on the CastingPlayer UX.",
                    f"cast setcommissionerpasscode {int(COMMISSIONER_GENERATED_PASSCODE, 16)}",
                    "Awaiting user input",
                ],
            ),
            ...
            Step(
                ...
                output_msg=[
                    "IdentificationDeclarationOptions::LogDetail()",
                    "IdentificationDeclarationOptions::mCommissionerPasscode:      true",
                    "IdentificationDeclarationOptions::mCommissionerPasscodeReady: true",
                    "IdentificationDeclarationOptions::TargetAppInfos list:",
                    f"TargetAppInfo 1, Vendor ID: {VENDOR_ID}",
                ],
            ),
