...
def darwinframeworktool_runner_options(f):
    f = click.option(
        "--server_path", type=click.Path(exists=True), default=None, help="Path to an websocket server to run at launch."
    )(f)
    f = click.option(
        "--server_name", type=str, default="darwin-framework-tool", help="Name of a websocket server to run at launch."
    )(f)
    f = click.option(
        "--server_arguments",
        type=str,
        default="interactive server",
        help="Optional arguments to pass to the websocket server at launch.",
    )(f)
    f = click.option(
