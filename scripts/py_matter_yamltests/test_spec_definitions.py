...
class TestSpecDefinitions(unittest.TestCase):
    ...
    def test_response_name_with_nullable(self):
        ...
        self.assertEqual(definitions.get_response_name(0x1234, 0x0), response_name)

        response = definitions.get_response_by_name(cluster_name, response_name)
    ...
    def test_event_name(self):
        ...
        self.assertEqual(definitions.get_event_name(0x1234, 0x1), "TestEventFabricScoped")
    ...
    def test_get_bitmap_by_name(self):
        ...
        self.assertIsNone(definitions.get_bitmap_by_name("TestWrong", "TestBitmap"))
        ...
        self.assertIsInstance(definitions.get_bitmap_by_name("Test", "TestGlobalBitmap"), Bitmap)
        self.assertIsInstance(definitions.get_bitmap_by_name("TestWrong", "TestGlobalBitmap"), Bitmap)
    ...
    def test_get_enum_by_name(self):
        ...
        self.assertIsNone(definitions.get_enum_by_name("TestWrong", "TestEnum"))
        ...
        self.assertIsInstance(definitions.get_enum_by_name("Test", "TestGlobalEnum"), Enum)
        self.assertIsInstance(definitions.get_enum_by_name("TestWrong", "TestGlobalEnum"), Enum)
    ...
    def test_get_struct_by_name(self):
        ...
        self.assertIsNone(definitions.get_struct_by_name("TestWrong", "TestStruct"))
        ...
        self.assertIsInstance(definitions.get_struct_by_name("Test", "TestGlobalStruct"), Struct)
        self.assertIsInstance(definitions.get_struct_by_name("TestWrong", "TestGlobalStruct"), Struct)
    ...
    def test_get_type_by_name(self):
        ...
        definitions = SpecDefinitions([ParseSource(source=io.StringIO(source_event), name="source_event")])
        self.assertIsInstance(definitions.get_type_by_name("Test", "TestEvent"), Event)

        definitions = SpecDefinitions([ParseSource(source=io.StringIO(source_bitmap), name="source_bitmap")])
        self.assertIsInstance(definitions.get_type_by_name("Test", "TestBitmap"), Bitmap)
        self.assertIsInstance(definitions.get_type_by_name("Test", "TestGlobalBitmap"), Bitmap)

        definitions = SpecDefinitions([ParseSource(source=io.StringIO(source_enum), name="source_enum")])
        self.assertIsInstance(definitions.get_type_by_name("Test", "TestEnum"), Enum)
        self.assertIsInstance(definitions.get_type_by_name("Test", "TestGlobalEnum"), Enum)

        definitions = SpecDefinitions([ParseSource(source=io.StringIO(source_struct), name="source_struct")])
        self.assertIsInstance(definitions.get_type_by_name("Test", "TestStruct"), Struct)
        self.assertIsInstance(definitions.get_type_by_name("Test", "TestGlobalStruct"), Struct)
    ...
    def test_event_is_fabric_scoped(self):
        ...
        event = definitions.get_event_by_name("Test", "TestEventFabricScoped")
